<%
int rowCount = allocationTypes.size();
...
<aui:row>	
	...
	<%
		...
		{
			MasterFile masterFile = allocationTypes.get(cur);
		
			String valueTitle = EisUtil.EXPENSE_TYPE_ALLOCATION +"-"+ masterFile.getMasterFileId() +"-value";
