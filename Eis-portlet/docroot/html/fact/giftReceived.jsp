...
<%
	...
	List<MasterFile> items = MasterFileLocalServiceUtil.findByMasterType(itemTypeId, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	...
	String headerTitle = LanguageUtil.get(pageContext, "gift-received");
...
<portlet:actionURL name="editGiftReceived" var="actionURL">
...
>
	...
	<liferay-ui:section>
		<%@include file="/html/fact/data_entry/giftReceived.jsp"%>
...
<portlet:resourceURL var="loadItemURL" id="<%= EisUtil.RESOURCE_GIFT_RECEIVED %>">
            ...
            on: {
                 success: function() {
                 	...
                 	A.Array.each(data, function(obj, idx){
                 		 var titleTotal = A.one('#<portlet:namespace/>'+ obj.itemId +'-title');
                 		 var volumeTotal = A.one('#<portlet:namespace/>'+ obj.itemId +'-volume');
...
<%!
	private static Log LOGGER = LogFactoryUtil.getLog("html.fact.giftReceived"); 
%>
