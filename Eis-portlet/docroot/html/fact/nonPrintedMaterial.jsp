...
<%
	...
	List<MasterFile> items = MasterFileLocalServiceUtil.findByTypeAndStatus2(itemTypeId, true);// .findByMasterType(itemTypeId,QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	...
	int cur = 0;
	String headerTitle = LanguageUtil.get(pageContext, "non-printed-material");
...
<portlet:actionURL name="editNonPrintedItem" var="nonPrintedItemURL">
	
</portlet:actionURL>



<aui:form name="fm" action="<%= nonPrintedItemURL %>">
...
>
	...
	<liferay-ui:section>
		<%@include file="/html/fact/data_entry/nonPrintedMaterial.jsp"%>
...
<portlet:resourceURL var="loadItemURL" id="<%= EisUtil.RESOURCE_NON_PRINTED_ITEM_DATA %>">
            ...
            on: {
                 success: function() {
		            ...
		            %>
		            	...
		            	var columns = [
		            	          {key: 'Bil',className:'numeric',width:'5%'},
		            	          {key:'Pengguna',width:'35%'},
		            	          {key:'Tarikh'},
		            	          {key:'Jenis Bahan',width:'35%'},
		            	          {
		            	        	  key:'Judul',
