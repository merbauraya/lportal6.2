...
<liferay-portlet:renderURL varImpl="iteratorURL">
       ...
       <portlet:param name="navigation" value="nonPrintedItemType"/>
</liferay-portlet:renderURL>



<h4><%= LanguageUtil.get(locale, "non-printed-item") %></h4>
...
<liferay-ui:search-container emptyResultsMessage="no-item-type-were-found"
	delta="10"
	iteratorURL="<%= iteratorURL %>"
	
>
	<liferay-ui:search-container-results
		results="<%= NonPrintedItemTypeLocalServiceUtil.getNonPrintedItemTypes(searchContainer.getStart(), searchContainer.getEnd()) %>"
		total="<%= NonPrintedItemTypeLocalServiceUtil.getNonPrintedItemTypesCount() %>" />

	<liferay-ui:search-container-row
				className="com.idetronic.eis.model.NonPrintedItemType"
...
<aui:script position="inline" use="aui-base,liferay-portlet-url">
			...
			editButton.on(
				...
				function(e) {
					...
					editURL.setParameter('mvcPath', '/html/admin/editNonPrintedItemType.jsp');
