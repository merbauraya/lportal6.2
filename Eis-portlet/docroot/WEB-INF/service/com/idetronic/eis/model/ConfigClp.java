 ...
 * @author Mazlan Mat
 */
public class ConfigClp extends BaseModelImpl<Config> implements Config {
	public ConfigClp() {
	}
	...
	public void setId(long id) {
		...
		if (_configRemoteModel != null) {
			try {
				...
				method.invoke(_configRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setKey(String key) {
		...
		if (_configRemoteModel != null) {
			try {
				...
				method.invoke(_configRemoteModel, key);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getConfigRemoteModel() {
		return _configRemoteModel;
	}

	public void setConfigRemoteModel(BaseModel<?> configRemoteModel) {
		_configRemoteModel = configRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _configRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_configRemoteModel,
	...
	public Config toEscapedModel() {
		return (Config)ProxyUtil.newProxyInstance(Config.class.getClassLoader(),
			new Class[] { Config.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		ConfigClp clone = new ConfigClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ConfigClp)) {
			return false;
		}

		ConfigClp config = (ConfigClp)obj;
