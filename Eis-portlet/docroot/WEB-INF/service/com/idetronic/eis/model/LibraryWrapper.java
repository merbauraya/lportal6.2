...
public class LibraryWrapper implements Library, ModelWrapper<Library> {
	...
	*/
	...
	/**
	* Returns the state ID of this library.
	*
	* @return the state ID of this library
	*/
	@Override
	public long getStateId() {
		return _library.getStateId();
	}

	/**
	* Sets the state ID of this library.
	*
	* @param stateId the state ID of this library
	*/
	@Override
	public void setStateId(long stateId) {
		_library.setStateId(stateId);
	}
