...
/**
 * This class is used by SOAP remote services, specifically {@link com.idetronic.eis.service.http.ProjectResourceServiceSoap}.
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.http.ProjectResourceServiceSoap
 * @generated
 */
public class ProjectResourceSoap implements Serializable {
	...
	public static ProjectResourceSoap[] toSoapModels(ProjectResource[] models) {
		ProjectResourceSoap[] soapModels = new ProjectResourceSoap[models.length];
	...
	public static ProjectResourceSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new ProjectResourceSoap[models.length][models[0].length];
		}
		else {
	...
	public static ProjectResourceSoap[] toSoapModels(
		...
		List<ProjectResourceSoap> soapModels = new ArrayList<ProjectResourceSoap>(models.size());
