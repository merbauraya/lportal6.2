...
/**
 * The persistence utility for the fact data service. This utility wraps {@link FactDataPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class FactDataUtil {
	 ...
	 */
	public static void clearCache(FactData factData) {
		getPersistence().clearCache(factData);
	}
	 ...
	 */
	public static List<FactData> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<FactData> findWithDynamicQuery(
	 ...
	 */
	public static FactData update(FactData factData) throws SystemException {
		return getPersistence().update(factData);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static FactData update(FactData factData,
		ServiceContext serviceContext) throws SystemException {
		return getPersistence().update(factData, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.idetronic.eis.model.FactData factData) {
		getPersistence().cacheResult(factData);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factDatas);
	}
	...
	*/
	public static com.idetronic.eis.model.FactData create(long factId) {
	...
	*/
	public static com.idetronic.eis.model.FactData remove(long factId)
		throws com.idetronic.eis.NoSuchFactDataException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(factId);
	}

	public static com.idetronic.eis.model.FactData updateImpl(
		com.idetronic.eis.model.FactData factData)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(factData);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactData findByPrimaryKey(long factId)
		throws com.idetronic.eis.NoSuchFactDataException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactData fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.FactData> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FactDataPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FactDataPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactDataPersistence.class.getName());

			ReferenceRegistry.registerReference(FactDataUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FactDataPersistence persistence) {
	}

	private static FactDataPersistence _persistence;
}