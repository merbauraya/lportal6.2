...
/**
 * The persistence utility for the fact library visitor service. This utility wraps {@link FactLibraryVisitorPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class FactLibraryVisitorUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(FactLibraryVisitor factLibraryVisitor) {
		getPersistence().clearCache(factLibraryVisitor);
	}
	 ...
	 */
	public static List<FactLibraryVisitor> findWithDynamicQuery(
	 ...
	 */
	public static FactLibraryVisitor update(
		FactLibraryVisitor factLibraryVisitor) throws SystemException {
		return getPersistence().update(factLibraryVisitor);
	}
	 ...
	 */
	public static FactLibraryVisitor update(
		FactLibraryVisitor factLibraryVisitor, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(factLibraryVisitor, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factLibraryVisitor);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factLibraryVisitors);
	}
	...
	*/
	public static com.idetronic.eis.model.FactLibraryVisitor create(long factId) {
	...
	*/
	public static com.idetronic.eis.model.FactLibraryVisitor remove(long factId)
		throws com.idetronic.eis.NoSuchFactLibraryVisitorException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(factId);
	}

	public static com.idetronic.eis.model.FactLibraryVisitor updateImpl(
		com.idetronic.eis.model.FactLibraryVisitor factLibraryVisitor)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(factLibraryVisitor);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactLibraryVisitor findByPrimaryKey(
		long factId)
		throws com.idetronic.eis.NoSuchFactLibraryVisitorException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactLibraryVisitor fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.FactLibraryVisitor> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FactLibraryVisitorPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FactLibraryVisitorPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactLibraryVisitorPersistence.class.getName());

			ReferenceRegistry.registerReference(FactLibraryVisitorUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FactLibraryVisitorPersistence persistence) {
	}

	private static FactLibraryVisitorPersistence _persistence;
}