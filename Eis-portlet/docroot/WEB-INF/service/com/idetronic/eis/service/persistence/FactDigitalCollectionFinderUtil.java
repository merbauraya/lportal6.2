 ...
 * @author Mazlan Mat
 */
public class FactDigitalCollectionFinderUtil {
	...
	public static FactDigitalCollectionFinder getFinder() {
		if (_finder == null) {
			_finder = (FactDigitalCollectionFinder)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactDigitalCollectionFinder.class.getName());

			ReferenceRegistry.registerReference(FactDigitalCollectionFinderUtil.class,
				"_finder");
		}
	...
	public void setFinder(FactDigitalCollectionFinder finder) {
		_finder = finder;
	...
	private static FactDigitalCollectionFinder _finder;
}