...
/**
 * Provides the local service interface for FactInterLibLoan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see FactInterLibLoanLocalServiceUtil
...
public interface FactInterLibLoanLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FactInterLibLoanLocalServiceUtil} to access the fact inter lib loan local service. Add custom service methods to {@link com.idetronic.eis.service.impl.FactInterLibLoanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
