...
/**
 * The persistence utility for the non printed item type service. This utility wraps {@link NonPrintedItemTypePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class NonPrintedItemTypeUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(NonPrintedItemType nonPrintedItemType) {
		getPersistence().clearCache(nonPrintedItemType);
	}
	 ...
	 */
	public static List<NonPrintedItemType> findWithDynamicQuery(
	 ...
	 */
	public static NonPrintedItemType update(
		NonPrintedItemType nonPrintedItemType) throws SystemException {
		return getPersistence().update(nonPrintedItemType);
	}
	 ...
	 */
	public static NonPrintedItemType update(
		NonPrintedItemType nonPrintedItemType, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(nonPrintedItemType, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(nonPrintedItemType);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(nonPrintedItemTypes);
	}
	...
	*/
	public static com.idetronic.eis.model.NonPrintedItemType create(
		long itemTypeId) {
	...
	*/
	public static com.idetronic.eis.model.NonPrintedItemType remove(
		long itemTypeId)
	...
	public static com.idetronic.eis.model.NonPrintedItemType updateImpl(
		com.idetronic.eis.model.NonPrintedItemType nonPrintedItemType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(nonPrintedItemType);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.NonPrintedItemType findByPrimaryKey(
		long itemTypeId)
		throws com.idetronic.eis.NoSuchNonPrintedItemTypeException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.NonPrintedItemType fetchByPrimaryKey(
		long itemTypeId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.NonPrintedItemType> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static NonPrintedItemTypePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (NonPrintedItemTypePersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					NonPrintedItemTypePersistence.class.getName());

			ReferenceRegistry.registerReference(NonPrintedItemTypeUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(NonPrintedItemTypePersistence persistence) {
	}

	private static NonPrintedItemTypePersistence _persistence;
}