...
/**
 * The persistence utility for the fact digital collection service. This utility wraps {@link FactDigitalCollectionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class FactDigitalCollectionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(FactDigitalCollection factDigitalCollection) {
		getPersistence().clearCache(factDigitalCollection);
	}
	 ...
	 */
	public static List<FactDigitalCollection> findWithDynamicQuery(
	 ...
	 */
	public static FactDigitalCollection update(
		FactDigitalCollection factDigitalCollection) throws SystemException {
		return getPersistence().update(factDigitalCollection);
	}
	...
	public static FactDigitalCollection update(
		...
		return getPersistence().update(factDigitalCollection, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factDigitalCollection);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factDigitalCollections);
	}
	...
	*/
	public static com.idetronic.eis.model.FactDigitalCollection create(
		long factId) {
	...
	*/
	public static com.idetronic.eis.model.FactDigitalCollection remove(
		long factId)
	...
	public static com.idetronic.eis.model.FactDigitalCollection updateImpl(
		com.idetronic.eis.model.FactDigitalCollection factDigitalCollection)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(factDigitalCollection);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactDigitalCollection findByPrimaryKey(
		long factId)
		throws com.idetronic.eis.NoSuchFactDigitalCollectionException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactDigitalCollection fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.FactDigitalCollection> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FactDigitalCollectionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FactDigitalCollectionPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactDigitalCollectionPersistence.class.getName());

			ReferenceRegistry.registerReference(FactDigitalCollectionUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FactDigitalCollectionPersistence persistence) {
	}

	private static FactDigitalCollectionPersistence _persistence;
}