...
/**
 * The persistence utility for the project strategy service. This utility wraps {@link ProjectStrategyPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ProjectStrategyUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ProjectStrategy projectStrategy) {
		getPersistence().clearCache(projectStrategy);
	}
	 ...
	 */
	public static List<ProjectStrategy> findWithDynamicQuery(
	 ...
	 */
	public static ProjectStrategy update(ProjectStrategy projectStrategy)
		throws SystemException {
		return getPersistence().update(projectStrategy);
	}
	...
	public static ProjectStrategy update(ProjectStrategy projectStrategy,
		...
		return getPersistence().update(projectStrategy, serviceContext);
	}
	...
	*/
	public static java.util.List<com.idetronic.eis.model.ProjectStrategy> findByProject(
		long projectId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy findByProject_First(
		long projectId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy fetchByProject_First(
		long projectId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy findByProject_Last(
		long projectId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.idetronic.eis.NoSuchProjectStrategyException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy fetchByProject_Last(
		long projectId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy[] findByProject_PrevAndNext(
		long projectStrategyId, long projectId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.idetronic.eis.NoSuchProjectStrategyException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByProject_PrevAndNext(projectStrategyId, projectId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(projectStrategy);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(projectStrategies);
	}
	...
	*/
	public static com.idetronic.eis.model.ProjectStrategy create(
		long projectStrategyId) {
		return getPersistence().create(projectStrategyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy remove(
		long projectStrategyId)
		throws com.idetronic.eis.NoSuchProjectStrategyException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(projectStrategyId);
	}

	public static com.idetronic.eis.model.ProjectStrategy updateImpl(
		com.idetronic.eis.model.ProjectStrategy projectStrategy)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(projectStrategy);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy findByPrimaryKey(
		long projectStrategyId)
		throws com.idetronic.eis.NoSuchProjectStrategyException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(projectStrategyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ProjectStrategy fetchByPrimaryKey(
		long projectStrategyId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(projectStrategyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.ProjectStrategy> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ProjectStrategyPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ProjectStrategyPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					ProjectStrategyPersistence.class.getName());

			ReferenceRegistry.registerReference(ProjectStrategyUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ProjectStrategyPersistence persistence) {
	}

	private static ProjectStrategyPersistence _persistence;
}