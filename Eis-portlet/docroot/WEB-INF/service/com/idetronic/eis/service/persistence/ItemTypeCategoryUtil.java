...
/**
 * The persistence utility for the item type category service. This utility wraps {@link ItemTypeCategoryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ItemTypeCategoryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ItemTypeCategory itemTypeCategory) {
		getPersistence().clearCache(itemTypeCategory);
	}
	 ...
	 */
	public static List<ItemTypeCategory> findWithDynamicQuery(
	 ...
	 */
	public static ItemTypeCategory update(ItemTypeCategory itemTypeCategory)
		throws SystemException {
		return getPersistence().update(itemTypeCategory);
	}
	...
	public static ItemTypeCategory update(ItemTypeCategory itemTypeCategory,
		...
		return getPersistence().update(itemTypeCategory, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(itemTypeCategory);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(itemTypeCategories);
	}
	...
	*/
	public static com.idetronic.eis.model.ItemTypeCategory create(
		long itemTypeCategoryId) {
		return getPersistence().create(itemTypeCategoryId);
	}
	...
	*/
	public static com.idetronic.eis.model.ItemTypeCategory remove(
		long itemTypeCategoryId)
		throws com.idetronic.eis.NoSuchItemTypeCategoryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(itemTypeCategoryId);
	}

	public static com.idetronic.eis.model.ItemTypeCategory updateImpl(
		com.idetronic.eis.model.ItemTypeCategory itemTypeCategory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(itemTypeCategory);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ItemTypeCategory findByPrimaryKey(
		long itemTypeCategoryId)
		throws com.idetronic.eis.NoSuchItemTypeCategoryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(itemTypeCategoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.ItemTypeCategory fetchByPrimaryKey(
		long itemTypeCategoryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(itemTypeCategoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.ItemTypeCategory> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ItemTypeCategoryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ItemTypeCategoryPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					ItemTypeCategoryPersistence.class.getName());

			ReferenceRegistry.registerReference(ItemTypeCategoryUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ItemTypeCategoryPersistence persistence) {
	}

	private static ItemTypeCategoryPersistence _persistence;
}