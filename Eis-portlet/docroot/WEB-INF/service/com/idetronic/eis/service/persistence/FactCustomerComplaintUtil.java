...
/**
 * The persistence utility for the fact customer complaint service. This utility wraps {@link FactCustomerComplaintPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class FactCustomerComplaintUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(FactCustomerComplaint factCustomerComplaint) {
		getPersistence().clearCache(factCustomerComplaint);
	}
	 ...
	 */
	public static List<FactCustomerComplaint> findWithDynamicQuery(
	 ...
	 */
	public static FactCustomerComplaint update(
		FactCustomerComplaint factCustomerComplaint) throws SystemException {
		return getPersistence().update(factCustomerComplaint);
	}
	...
	public static FactCustomerComplaint update(
		...
		return getPersistence().update(factCustomerComplaint, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factCustomerComplaint);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factCustomerComplaints);
	}
	...
	*/
	public static com.idetronic.eis.model.FactCustomerComplaint create(
		long factId) {
	...
	*/
	public static com.idetronic.eis.model.FactCustomerComplaint remove(
		long factId)
	...
	public static com.idetronic.eis.model.FactCustomerComplaint updateImpl(
		com.idetronic.eis.model.FactCustomerComplaint factCustomerComplaint)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(factCustomerComplaint);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactCustomerComplaint findByPrimaryKey(
		long factId)
		throws com.idetronic.eis.NoSuchFactCustomerComplaintException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactCustomerComplaint fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.FactCustomerComplaint> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FactCustomerComplaintPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FactCustomerComplaintPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactCustomerComplaintPersistence.class.getName());

			ReferenceRegistry.registerReference(FactCustomerComplaintUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FactCustomerComplaintPersistence persistence) {
	}

	private static FactCustomerComplaintPersistence _persistence;
}