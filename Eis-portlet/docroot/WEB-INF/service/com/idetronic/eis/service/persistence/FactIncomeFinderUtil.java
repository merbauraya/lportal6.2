 ...
 * @author Mazlan Mat
 */
public class FactIncomeFinderUtil {
	...
	public static FactIncomeFinder getFinder() {
		if (_finder == null) {
			_finder = (FactIncomeFinder)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactIncomeFinder.class.getName());

			ReferenceRegistry.registerReference(FactIncomeFinderUtil.class,
				"_finder");
		}
	...
	public void setFinder(FactIncomeFinder finder) {
		_finder = finder;
	...
	private static FactIncomeFinder _finder;
}