...
/**
 * The persistence utility for the library seating department service. This utility wraps {@link LibrarySeatingDepartmentPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class LibrarySeatingDepartmentUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(librarySeatingDepartment);
	}
	 ...
	 */
	public static List<LibrarySeatingDepartment> findWithDynamicQuery(
	 ...
	 */
	public static LibrarySeatingDepartment update(
		LibrarySeatingDepartment librarySeatingDepartment)
		throws SystemException {
		return getPersistence().update(librarySeatingDepartment);
	}
	...
	public static LibrarySeatingDepartment update(
		...
		return getPersistence().update(librarySeatingDepartment, serviceContext);
	}
	...
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment findByLibraryDepartment(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment fetchByLibraryDepartment(
		long libraryId, long departmentId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByLibraryDepartment(libraryId, departmentId);
	}
	...
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment fetchByLibraryDepartment(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByLibraryDepartment(libraryId, departmentId,
			retrieveFromCache);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment removeByLibraryDepartment(
		long libraryId, long departmentId)
		throws com.idetronic.eis.NoSuchLibrarySeatingDepartmentException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .removeByLibraryDepartment(libraryId, departmentId);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(librarySeatingDepartment);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(librarySeatingDepartments);
	}
	...
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment create(
		long libraryDepartmentId) {
		return getPersistence().create(libraryDepartmentId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment remove(
		long libraryDepartmentId)
		throws com.idetronic.eis.NoSuchLibrarySeatingDepartmentException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(libraryDepartmentId);
	}

	public static com.idetronic.eis.model.LibrarySeatingDepartment updateImpl(
		com.idetronic.eis.model.LibrarySeatingDepartment librarySeatingDepartment)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(librarySeatingDepartment);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment findByPrimaryKey(
		long libraryDepartmentId)
		throws com.idetronic.eis.NoSuchLibrarySeatingDepartmentException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(libraryDepartmentId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.LibrarySeatingDepartment fetchByPrimaryKey(
		long libraryDepartmentId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(libraryDepartmentId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.LibrarySeatingDepartment> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LibrarySeatingDepartmentPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LibrarySeatingDepartmentPersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					LibrarySeatingDepartmentPersistence.class.getName());

			ReferenceRegistry.registerReference(LibrarySeatingDepartmentUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LibrarySeatingDepartmentPersistence persistence) {
	}

	private static LibrarySeatingDepartmentPersistence _persistence;
}