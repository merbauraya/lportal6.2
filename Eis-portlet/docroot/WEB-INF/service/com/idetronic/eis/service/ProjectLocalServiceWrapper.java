...
public class ProjectLocalServiceWrapper implements ProjectLocalService,
	...
	*/
	...
	public com.idetronic.eis.model.Project addProject(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _projectLocalService.addProject(projectName, projectStatus,
			startDate, endDate, progressStatus, progress, resourceName,
			resourceType, completionDate, serviceContext);
	}
	...
	*/
	...
	public void deleteProjectAll(long projectId)
		throws com.liferay.portal.kernel.exception.SystemException {
		_projectLocalService.deleteProjectAll(projectId);
	}
