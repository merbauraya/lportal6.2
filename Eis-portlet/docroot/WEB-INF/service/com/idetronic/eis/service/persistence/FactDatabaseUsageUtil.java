...
/**
 * The persistence utility for the fact database usage service. This utility wraps {@link FactDatabaseUsagePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FactDatabaseUsagePersistenceImpl
 * @generated
 */
public class FactDatabaseUsageUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(FactDatabaseUsage factDatabaseUsage) {
		getPersistence().clearCache(factDatabaseUsage);
	}
	 ...
	 */
	public static List<FactDatabaseUsage> findWithDynamicQuery(
	 ...
	 */
	public static FactDatabaseUsage update(FactDatabaseUsage factDatabaseUsage)
		throws SystemException {
		return getPersistence().update(factDatabaseUsage);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static FactDatabaseUsage update(
		FactDatabaseUsage factDatabaseUsage, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(factDatabaseUsage, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(factDatabaseUsage);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.idetronic.eis.model.FactDatabaseUsage> factDatabaseUsages) {
		getPersistence().cacheResult(factDatabaseUsages);
	}
	...
	*/
	public static com.idetronic.eis.model.FactDatabaseUsage create(long factId) {
	...
	*/
	public static com.idetronic.eis.model.FactDatabaseUsage remove(long factId)
		throws com.idetronic.eis.NoSuchFactDatabaseUsageException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(factId);
	}

	public static com.idetronic.eis.model.FactDatabaseUsage updateImpl(
		com.idetronic.eis.model.FactDatabaseUsage factDatabaseUsage)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(factDatabaseUsage);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactDatabaseUsage findByPrimaryKey(
		long factId)
		throws com.idetronic.eis.NoSuchFactDatabaseUsageException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.eis.model.FactDatabaseUsage fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.eis.model.FactDatabaseUsage> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FactDatabaseUsagePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FactDatabaseUsagePersistence)PortletBeanLocatorUtil.locate(com.idetronic.eis.service.ClpSerializer.getServletContextName(),
					FactDatabaseUsagePersistence.class.getName());

			ReferenceRegistry.registerReference(FactDatabaseUsageUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FactDatabaseUsagePersistence persistence) {
	}

	private static FactDatabaseUsagePersistence _persistence;
}