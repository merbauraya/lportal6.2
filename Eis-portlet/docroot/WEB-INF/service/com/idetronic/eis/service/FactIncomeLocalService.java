...
/**
 * Provides the local service interface for FactIncome. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see FactIncomeLocalServiceUtil
...
public interface FactIncomeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FactIncomeLocalServiceUtil} to access the fact income local service. Add custom service methods to {@link com.idetronic.eis.service.impl.FactIncomeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
