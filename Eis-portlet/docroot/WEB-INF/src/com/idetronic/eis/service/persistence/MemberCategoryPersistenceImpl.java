...
import com.idetronic.eis.NoSuchMemberCategoryException;
import com.idetronic.eis.model.MemberCategory;
import com.idetronic.eis.model.impl.MemberCategoryImpl;
import com.idetronic.eis.model.impl.MemberCategoryModelImpl;
...
public class MemberCategoryPersistenceImpl extends BasePersistenceImpl<MemberCategory>
	 ...
	 */
	@Override
	public MemberCategory create(long memberCategoryId) {
		MemberCategory memberCategory = new MemberCategoryImpl();

		memberCategory.setNew(true);
		memberCategory.setPrimaryKey(memberCategoryId);
	 ...
	 */
	@Override
	public MemberCategory remove(long memberCategoryId)
		throws NoSuchMemberCategoryException, SystemException {
		return remove((Serializable)memberCategoryId);
	}
	...
	protected MemberCategory toUnwrappedModel(MemberCategory memberCategory) {
		...
		memberCategoryImpl.setMemberCategoryId(memberCategory.getMemberCategoryId());
		memberCategoryImpl.setMemberCategoryName(memberCategory.getMemberCategoryName());
		memberCategoryImpl.setMemberCategoryGroupName(memberCategory.getMemberCategoryGroupName());
		memberCategoryImpl.setActive(memberCategory.isActive());
	 ...
	 */
	@Override
	public MemberCategory findByPrimaryKey(long memberCategoryId)
		throws NoSuchMemberCategoryException, SystemException {
		return findByPrimaryKey((Serializable)memberCategoryId);
	}
	 ...
	 */
	@Override
	public MemberCategory fetchByPrimaryKey(long memberCategoryId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)memberCategoryId);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.idetronic.eis.model.MemberCategory")));
