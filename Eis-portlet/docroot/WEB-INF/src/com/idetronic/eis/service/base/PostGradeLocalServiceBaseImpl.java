...
import com.idetronic.eis.service.PostGradeLocalService;
...
/**
 * Provides the base implementation for the post grade local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.PostGradeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class PostGradeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PostGradeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.PostGradeLocalServiceUtil} to access the post grade local service.
	 */
	...
	@Override
	public PostGrade addPostGrade(PostGrade postGrade)
	 ...
	 */
	@Override
	public PostGrade createPostGrade(long postGradeId) {
		return postGradePersistence.create(postGradeId);
	}
	...
	@Override
	public PostGrade deletePostGrade(long postGradeId)
		throws PortalException, SystemException {
		return postGradePersistence.remove(postGradeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PostGrade deletePostGrade(PostGrade postGrade)
		throws SystemException {
		return postGradePersistence.remove(postGrade);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PostGrade.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return postGradePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return postGradePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return postGradePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PostGrade fetchPostGrade(long postGradeId) throws SystemException {
		return postGradePersistence.fetchByPrimaryKey(postGradeId);
	}
	 ...
	 */
	@Override
	public PostGrade getPostGrade(long postGradeId)
		throws PortalException, SystemException {
		return postGradePersistence.findByPrimaryKey(postGradeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return postGradePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PostGrade> getPostGrades(int start, int end)
		throws SystemException {
		return postGradePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPostGradesCount() throws SystemException {
		return postGradePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PostGrade updatePostGrade(PostGrade postGrade)
		throws SystemException {
		return postGradePersistence.update(postGrade);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.PostGrade",
			postGradeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = postGradePersistence.getDataSource();
	...
	private PostGradeLocalServiceClpInvoker _clpInvoker = new PostGradeLocalServiceClpInvoker();
}