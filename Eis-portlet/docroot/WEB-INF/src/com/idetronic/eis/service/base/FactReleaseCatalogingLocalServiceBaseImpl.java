...
import com.idetronic.eis.service.FactReleaseCatalogingLocalService;
...
/**
 * Provides the base implementation for the fact release cataloging local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactReleaseCatalogingLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactReleaseCatalogingLocalServiceImpl
 * @see com.idetronic.eis.service.FactReleaseCatalogingLocalServiceUtil
 * @generated
 */
public abstract class FactReleaseCatalogingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactReleaseCatalogingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactReleaseCatalogingLocalServiceUtil} to access the fact release cataloging local service.
	 */
	...
	@Override
	public FactReleaseCataloging addFactReleaseCataloging(
		FactReleaseCataloging factReleaseCataloging) throws SystemException {
		factReleaseCataloging.setNew(true);

		return factReleaseCatalogingPersistence.update(factReleaseCataloging);
	}
	 ...
	 */
	@Override
	public FactReleaseCataloging createFactReleaseCataloging(long factId) {
		return factReleaseCatalogingPersistence.create(factId);
	}
	...
	@Override
	public FactReleaseCataloging deleteFactReleaseCataloging(long factId)
		throws PortalException, SystemException {
		return factReleaseCatalogingPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactReleaseCataloging deleteFactReleaseCataloging(
		FactReleaseCataloging factReleaseCataloging) throws SystemException {
		return factReleaseCatalogingPersistence.remove(factReleaseCataloging);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactReleaseCataloging.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factReleaseCatalogingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factReleaseCatalogingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactReleaseCataloging fetchFactReleaseCataloging(long factId)
		throws SystemException {
		return factReleaseCatalogingPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactReleaseCataloging getFactReleaseCataloging(long factId)
		throws PortalException, SystemException {
		return factReleaseCatalogingPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factReleaseCatalogingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactReleaseCataloging> getFactReleaseCatalogings(int start,
		int end) throws SystemException {
		return factReleaseCatalogingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactReleaseCatalogingsCount() throws SystemException {
		return factReleaseCatalogingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactReleaseCataloging updateFactReleaseCataloging(
		FactReleaseCataloging factReleaseCataloging) throws SystemException {
		return factReleaseCatalogingPersistence.update(factReleaseCataloging);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactReleaseCataloging",
			factReleaseCatalogingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactReleaseCataloging");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factReleaseCatalogingPersistence.getDataSource();
	...
	private FactReleaseCatalogingLocalServiceClpInvoker _clpInvoker = new FactReleaseCatalogingLocalServiceClpInvoker();
}