...
import com.idetronic.eis.service.ItemMediumLocalService;
...
/**
 * Provides the base implementation for the item medium local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.ItemMediumLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.ItemMediumLocalServiceImpl
 * @see com.idetronic.eis.service.ItemMediumLocalServiceUtil
 * @generated
 */
public abstract class ItemMediumLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ItemMediumLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.ItemMediumLocalServiceUtil} to access the item medium local service.
	 */
	...
	@Override
	public ItemMedium addItemMedium(ItemMedium itemMedium)
	 ...
	 */
	@Override
	public ItemMedium createItemMedium(long itemMediumId) {
		return itemMediumPersistence.create(itemMediumId);
	}
	...
	@Override
	public ItemMedium deleteItemMedium(long itemMediumId)
		throws PortalException, SystemException {
		return itemMediumPersistence.remove(itemMediumId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ItemMedium deleteItemMedium(ItemMedium itemMedium)
		throws SystemException {
		return itemMediumPersistence.remove(itemMedium);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemMedium.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return itemMediumPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return itemMediumPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return itemMediumPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ItemMedium fetchItemMedium(long itemMediumId)
		throws SystemException {
		return itemMediumPersistence.fetchByPrimaryKey(itemMediumId);
	}
	 ...
	 */
	@Override
	public ItemMedium getItemMedium(long itemMediumId)
		throws PortalException, SystemException {
		return itemMediumPersistence.findByPrimaryKey(itemMediumId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return itemMediumPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ItemMedium> getItemMediums(int start, int end)
		throws SystemException {
		return itemMediumPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getItemMediumsCount() throws SystemException {
		return itemMediumPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ItemMedium updateItemMedium(ItemMedium itemMedium)
		throws SystemException {
		return itemMediumPersistence.update(itemMedium);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.ItemMedium",
			itemMediumLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.ItemMedium");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = itemMediumPersistence.getDataSource();
	...
	private ItemMediumLocalServiceClpInvoker _clpInvoker = new ItemMediumLocalServiceClpInvoker();
}