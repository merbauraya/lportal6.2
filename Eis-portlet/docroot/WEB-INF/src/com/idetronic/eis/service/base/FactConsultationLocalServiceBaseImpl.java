...
import com.idetronic.eis.service.FactConsultationLocalService;
...
/**
 * Provides the base implementation for the fact consultation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactConsultationLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactConsultationLocalServiceImpl
 * @see com.idetronic.eis.service.FactConsultationLocalServiceUtil
 * @generated
 */
public abstract class FactConsultationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactConsultationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactConsultationLocalServiceUtil} to access the fact consultation local service.
	 */
	...
	@Override
	public FactConsultation addFactConsultation(
		FactConsultation factConsultation) throws SystemException {
		factConsultation.setNew(true);

		return factConsultationPersistence.update(factConsultation);
	}
	 ...
	 */
	@Override
	public FactConsultation createFactConsultation(long factConsultationId) {
		return factConsultationPersistence.create(factConsultationId);
	}
	...
	@Override
	public FactConsultation deleteFactConsultation(long factConsultationId)
		throws PortalException, SystemException {
		return factConsultationPersistence.remove(factConsultationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactConsultation deleteFactConsultation(
		FactConsultation factConsultation) throws SystemException {
		return factConsultationPersistence.remove(factConsultation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactConsultation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factConsultationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factConsultationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactConsultation fetchFactConsultation(long factConsultationId)
		throws SystemException {
		return factConsultationPersistence.fetchByPrimaryKey(factConsultationId);
	}
	 ...
	 */
	@Override
	public FactConsultation getFactConsultation(long factConsultationId)
		throws PortalException, SystemException {
		return factConsultationPersistence.findByPrimaryKey(factConsultationId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factConsultationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactConsultation> getFactConsultations(int start, int end)
		throws SystemException {
		return factConsultationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactConsultationsCount() throws SystemException {
		return factConsultationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactConsultation updateFactConsultation(
		FactConsultation factConsultation) throws SystemException {
		return factConsultationPersistence.update(factConsultation);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactConsultation",
			factConsultationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactConsultation");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factConsultationPersistence.getDataSource();
	...
	private FactConsultationLocalServiceClpInvoker _clpInvoker = new FactConsultationLocalServiceClpInvoker();
}