...
import com.idetronic.eis.service.FactInterLibLoanLocalService;
...
/**
 * Provides the base implementation for the fact inter lib loan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactInterLibLoanLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactInterLibLoanLocalServiceImpl
 * @see com.idetronic.eis.service.FactInterLibLoanLocalServiceUtil
 * @generated
 */
public abstract class FactInterLibLoanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactInterLibLoanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactInterLibLoanLocalServiceUtil} to access the fact inter lib loan local service.
	 */
	...
	@Override
	public FactInterLibLoan addFactInterLibLoan(
		FactInterLibLoan factInterLibLoan) throws SystemException {
		factInterLibLoan.setNew(true);

		return factInterLibLoanPersistence.update(factInterLibLoan);
	}
	 ...
	 */
	@Override
	public FactInterLibLoan createFactInterLibLoan(long factId) {
		return factInterLibLoanPersistence.create(factId);
	}
	...
	@Override
	public FactInterLibLoan deleteFactInterLibLoan(long factId)
		throws PortalException, SystemException {
		return factInterLibLoanPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactInterLibLoan deleteFactInterLibLoan(
		FactInterLibLoan factInterLibLoan) throws SystemException {
		return factInterLibLoanPersistence.remove(factInterLibLoan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactInterLibLoan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factInterLibLoanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factInterLibLoanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactInterLibLoan fetchFactInterLibLoan(long factId)
		throws SystemException {
		return factInterLibLoanPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactInterLibLoan getFactInterLibLoan(long factId)
		throws PortalException, SystemException {
		return factInterLibLoanPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factInterLibLoanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactInterLibLoan> getFactInterLibLoans(int start, int end)
		throws SystemException {
		return factInterLibLoanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactInterLibLoansCount() throws SystemException {
		return factInterLibLoanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactInterLibLoan updateFactInterLibLoan(
		FactInterLibLoan factInterLibLoan) throws SystemException {
		return factInterLibLoanPersistence.update(factInterLibLoan);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactInterLibLoan",
			factInterLibLoanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactInterLibLoan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factInterLibLoanPersistence.getDataSource();
	...
	private FactInterLibLoanLocalServiceClpInvoker _clpInvoker = new FactInterLibLoanLocalServiceClpInvoker();
}