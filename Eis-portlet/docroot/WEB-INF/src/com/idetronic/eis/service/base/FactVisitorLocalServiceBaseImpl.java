...
import com.idetronic.eis.service.FactVisitorLocalService;
...
/**
 * Provides the base implementation for the fact visitor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactVisitorLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactVisitorLocalServiceImpl
 * @see com.idetronic.eis.service.FactVisitorLocalServiceUtil
 * @generated
 */
public abstract class FactVisitorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactVisitorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactVisitorLocalServiceUtil} to access the fact visitor local service.
	 */
	...
	@Override
	public FactVisitor addFactVisitor(FactVisitor factVisitor)
	 ...
	 */
	@Override
	public FactVisitor createFactVisitor(long factVisitorId) {
		return factVisitorPersistence.create(factVisitorId);
	}
	...
	@Override
	public FactVisitor deleteFactVisitor(long factVisitorId)
		throws PortalException, SystemException {
		return factVisitorPersistence.remove(factVisitorId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactVisitor deleteFactVisitor(FactVisitor factVisitor)
		throws SystemException {
		return factVisitorPersistence.remove(factVisitor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactVisitor.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factVisitorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return factVisitorPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factVisitorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactVisitor fetchFactVisitor(long factVisitorId)
		throws SystemException {
		return factVisitorPersistence.fetchByPrimaryKey(factVisitorId);
	}
	 ...
	 */
	@Override
	public FactVisitor getFactVisitor(long factVisitorId)
		throws PortalException, SystemException {
		return factVisitorPersistence.findByPrimaryKey(factVisitorId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factVisitorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactVisitor> getFactVisitors(int start, int end)
		throws SystemException {
		return factVisitorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactVisitorsCount() throws SystemException {
		return factVisitorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactVisitor updateFactVisitor(FactVisitor factVisitor)
		throws SystemException {
		return factVisitorPersistence.update(factVisitor);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactVisitor",
			factVisitorLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactVisitor");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factVisitorPersistence.getDataSource();
	...
	private FactVisitorLocalServiceClpInvoker _clpInvoker = new FactVisitorLocalServiceClpInvoker();
}