 ...
 * @generated
 */
public class FacultyServiceClpInvoker {
	public FacultyServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName256.equals(name) &&
			...
			return FacultyServiceUtil.getBeanIdentifier();
		}

		if (_methodName257.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes257, parameterTypes)) {
			FacultyServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
