...
import com.idetronic.eis.service.FactLibraryVisitorLocalService;
...
/**
 * Provides the base implementation for the fact library visitor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactLibraryVisitorLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactLibraryVisitorLocalServiceImpl
 * @see com.idetronic.eis.service.FactLibraryVisitorLocalServiceUtil
 * @generated
 */
public abstract class FactLibraryVisitorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactLibraryVisitorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactLibraryVisitorLocalServiceUtil} to access the fact library visitor local service.
	 */

	/**
	 * Adds the fact library visitor to the database. Also notifies the appropriate model listeners.
	 *
	 * @param factLibraryVisitor the fact library visitor
	 * @return the fact library visitor that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactLibraryVisitor addFactLibraryVisitor(
		FactLibraryVisitor factLibraryVisitor) throws SystemException {
		factLibraryVisitor.setNew(true);

		return factLibraryVisitorPersistence.update(factLibraryVisitor);
	}
	 ...
	 */
	@Override
	public FactLibraryVisitor createFactLibraryVisitor(long factId) {
		return factLibraryVisitorPersistence.create(factId);
	}

	/**
	 * Deletes the fact library visitor with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param factId the primary key of the fact library visitor
	 * @return the fact library visitor that was removed
	 * @throws PortalException if a fact library visitor with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactLibraryVisitor deleteFactLibraryVisitor(long factId)
		throws PortalException, SystemException {
		return factLibraryVisitorPersistence.remove(factId);
	}

	/**
	 * Deletes the fact library visitor from the database. Also notifies the appropriate model listeners.
	 *
	 * @param factLibraryVisitor the fact library visitor
	 * @return the fact library visitor that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactLibraryVisitor deleteFactLibraryVisitor(
		FactLibraryVisitor factLibraryVisitor) throws SystemException {
		return factLibraryVisitorPersistence.remove(factLibraryVisitor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactLibraryVisitor.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factLibraryVisitorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factLibraryVisitorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactLibraryVisitor fetchFactLibraryVisitor(long factId)
		throws SystemException {
		return factLibraryVisitorPersistence.fetchByPrimaryKey(factId);
	}

	/**
	 * Returns the fact library visitor with the primary key.
	 *
	 * @param factId the primary key of the fact library visitor
	 ...
	 */
	@Override
	public FactLibraryVisitor getFactLibraryVisitor(long factId)
		throws PortalException, SystemException {
		return factLibraryVisitorPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factLibraryVisitorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactLibraryVisitor> getFactLibraryVisitors(int start, int end)
		throws SystemException {
		return factLibraryVisitorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactLibraryVisitorsCount() throws SystemException {
		return factLibraryVisitorPersistence.countAll();
	}

	/**
	 * Updates the fact library visitor in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param factLibraryVisitor the fact library visitor
	 * @return the fact library visitor that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactLibraryVisitor updateFactLibraryVisitor(
		FactLibraryVisitor factLibraryVisitor) throws SystemException {
		return factLibraryVisitorPersistence.update(factLibraryVisitor);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactLibraryVisitor",
			factLibraryVisitorLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactLibraryVisitor");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factLibraryVisitorPersistence.getDataSource();
	...
	private FactLibraryVisitorLocalServiceClpInvoker _clpInvoker = new FactLibraryVisitorLocalServiceClpInvoker();
}