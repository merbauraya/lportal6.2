...
import com.idetronic.eis.service.FactIrSubmissionLocalService;
...
/**
 * Provides the base implementation for the fact ir submission local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactIrSubmissionLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactIrSubmissionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactIrSubmissionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactIrSubmissionLocalServiceUtil} to access the fact ir submission local service.
	 */
	...
	@Override
	public FactIrSubmission addFactIrSubmission(
		FactIrSubmission factIrSubmission) throws SystemException {
		factIrSubmission.setNew(true);

		return factIrSubmissionPersistence.update(factIrSubmission);
	}
	 ...
	 */
	@Override
	public FactIrSubmission createFactIrSubmission(long submissionId) {
		return factIrSubmissionPersistence.create(submissionId);
	}
	...
	@Override
	public FactIrSubmission deleteFactIrSubmission(long submissionId)
		throws PortalException, SystemException {
		return factIrSubmissionPersistence.remove(submissionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactIrSubmission deleteFactIrSubmission(
		FactIrSubmission factIrSubmission) throws SystemException {
		return factIrSubmissionPersistence.remove(factIrSubmission);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactIrSubmission.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factIrSubmissionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factIrSubmissionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactIrSubmission fetchFactIrSubmission(long submissionId)
		throws SystemException {
		return factIrSubmissionPersistence.fetchByPrimaryKey(submissionId);
	}
	 ...
	 */
	@Override
	public FactIrSubmission getFactIrSubmission(long submissionId)
		throws PortalException, SystemException {
		return factIrSubmissionPersistence.findByPrimaryKey(submissionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factIrSubmissionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactIrSubmission> getFactIrSubmissions(int start, int end)
		throws SystemException {
		return factIrSubmissionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactIrSubmissionsCount() throws SystemException {
		return factIrSubmissionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactIrSubmission updateFactIrSubmission(
		FactIrSubmission factIrSubmission) throws SystemException {
		return factIrSubmissionPersistence.update(factIrSubmission);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactIrSubmission",
			factIrSubmissionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factIrSubmissionPersistence.getDataSource();
	...
	private FactIrSubmissionLocalServiceClpInvoker _clpInvoker = new FactIrSubmissionLocalServiceClpInvoker();
}