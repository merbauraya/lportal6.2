...
import com.idetronic.eis.service.MasterFileLocalService;
...
/**
 * Provides the base implementation for the master file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.MasterFileLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class MasterFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MasterFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.MasterFileLocalServiceUtil} to access the master file local service.
	 */
	...
	@Override
	public MasterFile addMasterFile(MasterFile masterFile)
		throws SystemException {
		masterFile.setNew(true);

		return masterFilePersistence.update(masterFile);
	}
	 ...
	 */
	@Override
	public MasterFile createMasterFile(long masterFileId) {
		return masterFilePersistence.create(masterFileId);
	}
	...
	@Override
	public MasterFile deleteMasterFile(long masterFileId)
		throws PortalException, SystemException {
		return masterFilePersistence.remove(masterFileId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterFile deleteMasterFile(MasterFile masterFile)
		throws SystemException {
		return masterFilePersistence.remove(masterFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MasterFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return masterFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return masterFilePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return masterFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MasterFile fetchMasterFile(long masterFileId)
		throws SystemException {
		return masterFilePersistence.fetchByPrimaryKey(masterFileId);
	}
	 ...
	 */
	@Override
	public MasterFile getMasterFile(long masterFileId)
		throws PortalException, SystemException {
		return masterFilePersistence.findByPrimaryKey(masterFileId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return masterFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterFile> getMasterFiles(int start, int end)
		throws SystemException {
		return masterFilePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMasterFilesCount() throws SystemException {
		return masterFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterFile updateMasterFile(MasterFile masterFile)
		throws SystemException {
		return masterFilePersistence.update(masterFile);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.MasterFile",
			masterFileLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = masterFilePersistence.getDataSource();
	...
	private MasterFileLocalServiceClpInvoker _clpInvoker = new MasterFileLocalServiceClpInvoker();
}