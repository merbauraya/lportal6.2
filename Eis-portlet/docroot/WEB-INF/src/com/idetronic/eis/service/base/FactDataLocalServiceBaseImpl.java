...
import com.idetronic.eis.service.FactDataLocalService;
...
/**
 * Provides the base implementation for the fact data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactDataLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactDataLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FactDataLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactDataLocalServiceUtil} to access the fact data local service.
	 */
	...
	@Override
	public FactData addFactData(FactData factData) throws SystemException {
		factData.setNew(true);

		return factDataPersistence.update(factData);
	}
	 ...
	 */
	@Override
	public FactData createFactData(long factId) {
		return factDataPersistence.create(factId);
	}
	...
	@Override
	public FactData deleteFactData(long factId)
		throws PortalException, SystemException {
		return factDataPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactData deleteFactData(FactData factData) throws SystemException {
		return factDataPersistence.remove(factData);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactData.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factDataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return factDataPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return factDataPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factDataPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactData fetchFactData(long factId) throws SystemException {
		return factDataPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactData getFactData(long factId)
		throws PortalException, SystemException {
		return factDataPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factDataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactData> getFactDatas(int start, int end)
		throws SystemException {
		return factDataPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactDatasCount() throws SystemException {
		return factDataPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactData updateFactData(FactData factData) throws SystemException {
		return factDataPersistence.update(factData);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactData",
			factDataLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factDataPersistence.getDataSource();
	...
	private FactDataLocalServiceClpInvoker _clpInvoker = new FactDataLocalServiceClpInvoker();
}