...
public class FactInterLibLoanFinderImpl extends BasePersistenceImpl<FactInterLibLoan>
implements FactInterLibLoanFinder
{
	public List<FactInterLibLoan> getLatestEntry (long libraryId,String period)
	{
	    ...
	    try {
	        ...
	        q.addEntity("FactInterLibLoan", FactInterLibLoanImpl.class); 
	        ...
	        List<FactInterLibLoan> results = (List<FactInterLibLoan>) QueryUtil.list(q, getDialect(), QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	...
	private static Log LOGGER = LogFactoryUtil.getLog(FactInterLibLoanFinderImpl.class);
