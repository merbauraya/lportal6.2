...
import com.idetronic.eis.service.ItemTypeCategoryLocalService;
...
/**
 * Provides the base implementation for the item type category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.ItemTypeCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.ItemTypeCategoryLocalServiceImpl
 * @see com.idetronic.eis.service.ItemTypeCategoryLocalServiceUtil
 * @generated
 */
public abstract class ItemTypeCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ItemTypeCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.ItemTypeCategoryLocalServiceUtil} to access the item type category local service.
	 */
	...
	@Override
	public ItemTypeCategory addItemTypeCategory(
		ItemTypeCategory itemTypeCategory) throws SystemException {
		itemTypeCategory.setNew(true);

		return itemTypeCategoryPersistence.update(itemTypeCategory);
	}
	 ...
	 */
	@Override
	public ItemTypeCategory createItemTypeCategory(long itemTypeCategoryId) {
		return itemTypeCategoryPersistence.create(itemTypeCategoryId);
	}
	...
	@Override
	public ItemTypeCategory deleteItemTypeCategory(long itemTypeCategoryId)
		throws PortalException, SystemException {
		return itemTypeCategoryPersistence.remove(itemTypeCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ItemTypeCategory deleteItemTypeCategory(
		ItemTypeCategory itemTypeCategory) throws SystemException {
		return itemTypeCategoryPersistence.remove(itemTypeCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemTypeCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return itemTypeCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return itemTypeCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ItemTypeCategory fetchItemTypeCategory(long itemTypeCategoryId)
		throws SystemException {
		return itemTypeCategoryPersistence.fetchByPrimaryKey(itemTypeCategoryId);
	}
	 ...
	 */
	@Override
	public ItemTypeCategory getItemTypeCategory(long itemTypeCategoryId)
		throws PortalException, SystemException {
		return itemTypeCategoryPersistence.findByPrimaryKey(itemTypeCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return itemTypeCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ItemTypeCategory> getItemTypeCategories(int start, int end)
		throws SystemException {
		return itemTypeCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getItemTypeCategoriesCount() throws SystemException {
		return itemTypeCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ItemTypeCategory updateItemTypeCategory(
		ItemTypeCategory itemTypeCategory) throws SystemException {
		return itemTypeCategoryPersistence.update(itemTypeCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.ItemTypeCategory",
			itemTypeCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = itemTypeCategoryPersistence.getDataSource();
	...
	private ItemTypeCategoryLocalServiceClpInvoker _clpInvoker = new ItemTypeCategoryLocalServiceClpInvoker();
}