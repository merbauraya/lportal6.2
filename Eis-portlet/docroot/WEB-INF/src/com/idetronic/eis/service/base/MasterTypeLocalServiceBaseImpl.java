...
import com.idetronic.eis.service.MasterTypeLocalService;
...
/**
 * Provides the base implementation for the master type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.MasterTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class MasterTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MasterTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.MasterTypeLocalServiceUtil} to access the master type local service.
	 */
	...
	@Override
	public MasterType addMasterType(MasterType masterType)
		throws SystemException {
		masterType.setNew(true);

		return masterTypePersistence.update(masterType);
	}
	 ...
	 */
	@Override
	public MasterType createMasterType(long masterTypeId) {
		return masterTypePersistence.create(masterTypeId);
	}
	...
	@Override
	public MasterType deleteMasterType(long masterTypeId)
		throws PortalException, SystemException {
		return masterTypePersistence.remove(masterTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterType deleteMasterType(MasterType masterType)
		throws SystemException {
		return masterTypePersistence.remove(masterType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MasterType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return masterTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return masterTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return masterTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MasterType fetchMasterType(long masterTypeId)
		throws SystemException {
		return masterTypePersistence.fetchByPrimaryKey(masterTypeId);
	}
	 ...
	 */
	@Override
	public MasterType getMasterType(long masterTypeId)
		throws PortalException, SystemException {
		return masterTypePersistence.findByPrimaryKey(masterTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return masterTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterType> getMasterTypes(int start, int end)
		throws SystemException {
		return masterTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMasterTypesCount() throws SystemException {
		return masterTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterType updateMasterType(MasterType masterType)
		throws SystemException {
		return masterTypePersistence.update(masterType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.MasterType",
			masterTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.MasterType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = masterTypePersistence.getDataSource();
	...
	private MasterTypeLocalServiceClpInvoker _clpInvoker = new MasterTypeLocalServiceClpInvoker();
}