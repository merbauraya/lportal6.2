...
import com.idetronic.eis.service.FactMembershipLocalService;
...
/**
 * Provides the base implementation for the fact membership local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactMembershipLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactMembershipLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactMembershipLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactMembershipLocalServiceUtil} to access the fact membership local service.
	 */
	...
	@Override
	public FactMembership addFactMembership(FactMembership factMembership)
		throws SystemException {
		factMembership.setNew(true);

		return factMembershipPersistence.update(factMembership);
	}
	 ...
	 */
	@Override
	public FactMembership createFactMembership(long factMembershipId) {
		return factMembershipPersistence.create(factMembershipId);
	}
	...
	@Override
	public FactMembership deleteFactMembership(long factMembershipId)
		throws PortalException, SystemException {
		return factMembershipPersistence.remove(factMembershipId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactMembership deleteFactMembership(FactMembership factMembership)
		throws SystemException {
		return factMembershipPersistence.remove(factMembership);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactMembership.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factMembershipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factMembershipPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactMembership fetchFactMembership(long factMembershipId)
		throws SystemException {
		return factMembershipPersistence.fetchByPrimaryKey(factMembershipId);
	}
	 ...
	 */
	@Override
	public FactMembership getFactMembership(long factMembershipId)
		throws PortalException, SystemException {
		return factMembershipPersistence.findByPrimaryKey(factMembershipId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factMembershipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactMembership> getFactMemberships(int start, int end)
		throws SystemException {
		return factMembershipPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactMembershipsCount() throws SystemException {
		return factMembershipPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactMembership updateFactMembership(FactMembership factMembership)
		throws SystemException {
		return factMembershipPersistence.update(factMembership);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactMembership",
			factMembershipLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factMembershipPersistence.getDataSource();
	...
	private FactMembershipLocalServiceClpInvoker _clpInvoker = new FactMembershipLocalServiceClpInvoker();
}