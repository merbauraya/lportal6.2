...
import com.idetronic.eis.service.FactDatabaseUsageLocalService;
...
/**
 * Provides the base implementation for the fact database usage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactDatabaseUsageLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactDatabaseUsageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactDatabaseUsageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactDatabaseUsageLocalServiceUtil} to access the fact database usage local service.
	 */
	...
	@Override
	public FactDatabaseUsage addFactDatabaseUsage(
		FactDatabaseUsage factDatabaseUsage) throws SystemException {
		factDatabaseUsage.setNew(true);

		return factDatabaseUsagePersistence.update(factDatabaseUsage);
	}
	 ...
	 */
	@Override
	public FactDatabaseUsage createFactDatabaseUsage(long factId) {
		return factDatabaseUsagePersistence.create(factId);
	}
	...
	@Override
	public FactDatabaseUsage deleteFactDatabaseUsage(long factId)
		throws PortalException, SystemException {
		return factDatabaseUsagePersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactDatabaseUsage deleteFactDatabaseUsage(
		FactDatabaseUsage factDatabaseUsage) throws SystemException {
		return factDatabaseUsagePersistence.remove(factDatabaseUsage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactDatabaseUsage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factDatabaseUsagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factDatabaseUsagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactDatabaseUsage fetchFactDatabaseUsage(long factId)
		throws SystemException {
		return factDatabaseUsagePersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactDatabaseUsage getFactDatabaseUsage(long factId)
		throws PortalException, SystemException {
		return factDatabaseUsagePersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factDatabaseUsagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactDatabaseUsage> getFactDatabaseUsages(int start, int end)
		throws SystemException {
		return factDatabaseUsagePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactDatabaseUsagesCount() throws SystemException {
		return factDatabaseUsagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactDatabaseUsage updateFactDatabaseUsage(
		FactDatabaseUsage factDatabaseUsage) throws SystemException {
		return factDatabaseUsagePersistence.update(factDatabaseUsage);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactDatabaseUsage",
			factDatabaseUsageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactDatabaseUsage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factDatabaseUsagePersistence.getDataSource();
	...
	private FactDatabaseUsageLocalServiceClpInvoker _clpInvoker = new FactDatabaseUsageLocalServiceClpInvoker();
}