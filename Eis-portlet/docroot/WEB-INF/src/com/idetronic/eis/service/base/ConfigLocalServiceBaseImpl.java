...
import com.idetronic.eis.service.ConfigLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.ConfigLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
...
public abstract class ConfigLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ConfigLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.ConfigLocalServiceUtil} to access the config local service.
	 */
	...
	@Override
	public Config addConfig(Config config) throws SystemException {
		config.setNew(true);
	 ...
	 */
	@Override
	public Config createConfig(long id) {
		return configPersistence.create(id);
	}
	...
	@Override
	public Config deleteConfig(long id) throws PortalException, SystemException {
		return configPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Config deleteConfig(Config config) throws SystemException {
	...
	@Override
	public Config fetchConfig(long id) throws SystemException {
		return configPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public Config getConfig(long id) throws PortalException, SystemException {
		return configPersistence.findByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public int getConfigsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Config updateConfig(Config config) throws SystemException {
		return configPersistence.update(config);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.Config",
			configLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.Config");
	}
	...
	private ConfigLocalServiceClpInvoker _clpInvoker = new ConfigLocalServiceClpInvoker();
}