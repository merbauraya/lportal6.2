...
import com.idetronic.eis.service.FactArticleIndexingLocalService;
...
/**
 * Provides the base implementation for the fact article indexing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactArticleIndexingLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactArticleIndexingLocalServiceImpl
 * @see com.idetronic.eis.service.FactArticleIndexingLocalServiceUtil
 * @generated
 */
public abstract class FactArticleIndexingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactArticleIndexingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactArticleIndexingLocalServiceUtil} to access the fact article indexing local service.
	 */
	...
	@Override
	public FactArticleIndexing addFactArticleIndexing(
		FactArticleIndexing factArticleIndexing) throws SystemException {
		factArticleIndexing.setNew(true);

		return factArticleIndexingPersistence.update(factArticleIndexing);
	}
	 ...
	 */
	@Override
	public FactArticleIndexing createFactArticleIndexing(long factId) {
		return factArticleIndexingPersistence.create(factId);
	}
	...
	@Override
	public FactArticleIndexing deleteFactArticleIndexing(long factId)
		throws PortalException, SystemException {
		return factArticleIndexingPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactArticleIndexing deleteFactArticleIndexing(
		FactArticleIndexing factArticleIndexing) throws SystemException {
		return factArticleIndexingPersistence.remove(factArticleIndexing);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactArticleIndexing.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factArticleIndexingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factArticleIndexingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactArticleIndexing fetchFactArticleIndexing(long factId)
		throws SystemException {
		return factArticleIndexingPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactArticleIndexing getFactArticleIndexing(long factId)
		throws PortalException, SystemException {
		return factArticleIndexingPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factArticleIndexingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactArticleIndexing> getFactArticleIndexings(int start, int end)
		throws SystemException {
		return factArticleIndexingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactArticleIndexingsCount() throws SystemException {
		return factArticleIndexingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactArticleIndexing updateFactArticleIndexing(
		FactArticleIndexing factArticleIndexing) throws SystemException {
		return factArticleIndexingPersistence.update(factArticleIndexing);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactArticleIndexing",
			factArticleIndexingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactArticleIndexing");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factArticleIndexingPersistence.getDataSource();
	...
	private FactArticleIndexingLocalServiceClpInvoker _clpInvoker = new FactArticleIndexingLocalServiceClpInvoker();
}