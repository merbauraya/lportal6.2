...
import com.idetronic.eis.service.FactGiftReceivedLocalService;
...
/**
 * Provides the base implementation for the fact gift received local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactGiftReceivedLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactGiftReceivedLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactGiftReceivedLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactGiftReceivedLocalServiceUtil} to access the fact gift received local service.
	 */
	...
	@Override
	public FactGiftReceived addFactGiftReceived(
		FactGiftReceived factGiftReceived) throws SystemException {
		factGiftReceived.setNew(true);

		return factGiftReceivedPersistence.update(factGiftReceived);
	}
	 ...
	 */
	@Override
	public FactGiftReceived createFactGiftReceived(long factId) {
		return factGiftReceivedPersistence.create(factId);
	}
	...
	@Override
	public FactGiftReceived deleteFactGiftReceived(long factId)
		throws PortalException, SystemException {
		return factGiftReceivedPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactGiftReceived deleteFactGiftReceived(
		FactGiftReceived factGiftReceived) throws SystemException {
		return factGiftReceivedPersistence.remove(factGiftReceived);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactGiftReceived.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factGiftReceivedPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factGiftReceivedPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactGiftReceived fetchFactGiftReceived(long factId)
		throws SystemException {
		return factGiftReceivedPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactGiftReceived getFactGiftReceived(long factId)
		throws PortalException, SystemException {
		return factGiftReceivedPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factGiftReceivedPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactGiftReceived> getFactGiftReceiveds(int start, int end)
		throws SystemException {
		return factGiftReceivedPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactGiftReceivedsCount() throws SystemException {
		return factGiftReceivedPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactGiftReceived updateFactGiftReceived(
		FactGiftReceived factGiftReceived) throws SystemException {
		return factGiftReceivedPersistence.update(factGiftReceived);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactGiftReceived",
			factGiftReceivedLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factGiftReceivedPersistence.getDataSource();
	...
	private FactGiftReceivedLocalServiceClpInvoker _clpInvoker = new FactGiftReceivedLocalServiceClpInvoker();
}