...
import com.idetronic.eis.service.LibraryTypeLocalService;
...
/**
 * Provides the base implementation for the library type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.LibraryTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.LibraryTypeLocalServiceImpl
 * @see com.idetronic.eis.service.LibraryTypeLocalServiceUtil
 * @generated
 */
public abstract class LibraryTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LibraryTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.LibraryTypeLocalServiceUtil} to access the library type local service.
	 */
	...
	@Override
	public LibraryType addLibraryType(LibraryType libraryType)
	 ...
	 */
	@Override
	public LibraryType createLibraryType(long libraryTypeId) {
		return libraryTypePersistence.create(libraryTypeId);
	}
	...
	@Override
	public LibraryType deleteLibraryType(long libraryTypeId)
		throws PortalException, SystemException {
		return libraryTypePersistence.remove(libraryTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LibraryType deleteLibraryType(LibraryType libraryType)
		throws SystemException {
		return libraryTypePersistence.remove(libraryType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LibraryType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return libraryTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return libraryTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return libraryTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LibraryType fetchLibraryType(long libraryTypeId)
		throws SystemException {
		return libraryTypePersistence.fetchByPrimaryKey(libraryTypeId);
	}
	 ...
	 */
	@Override
	public LibraryType getLibraryType(long libraryTypeId)
		throws PortalException, SystemException {
		return libraryTypePersistence.findByPrimaryKey(libraryTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return libraryTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LibraryType> getLibraryTypes(int start, int end)
		throws SystemException {
		return libraryTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLibraryTypesCount() throws SystemException {
		return libraryTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LibraryType updateLibraryType(LibraryType libraryType)
		throws SystemException {
		return libraryTypePersistence.update(libraryType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.LibraryType",
			libraryTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = libraryTypePersistence.getDataSource();
	...
	private LibraryTypeLocalServiceClpInvoker _clpInvoker = new LibraryTypeLocalServiceClpInvoker();
}