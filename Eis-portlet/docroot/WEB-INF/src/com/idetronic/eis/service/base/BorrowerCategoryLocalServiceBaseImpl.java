...
import com.idetronic.eis.service.BorrowerCategoryLocalService;
import com.idetronic.eis.service.persistence.BorrowerCategoryPersistence;
...
/**
 * Provides the base implementation for the borrower category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.BorrowerCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.BorrowerCategoryLocalServiceImpl
 * @see com.idetronic.eis.service.BorrowerCategoryLocalServiceUtil
 * @generated
 */
public abstract class BorrowerCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BorrowerCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.BorrowerCategoryLocalServiceUtil} to access the borrower category local service.
	 */
	...
	@Override
	public BorrowerCategory addBorrowerCategory(
		BorrowerCategory borrowerCategory) throws SystemException {
		borrowerCategory.setNew(true);

		return borrowerCategoryPersistence.update(borrowerCategory);
	}
	 ...
	 */
	@Override
	public BorrowerCategory createBorrowerCategory(long borrowerCategoryId) {
		return borrowerCategoryPersistence.create(borrowerCategoryId);
	}
	...
	@Override
	public BorrowerCategory deleteBorrowerCategory(long borrowerCategoryId)
		throws PortalException, SystemException {
		return borrowerCategoryPersistence.remove(borrowerCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BorrowerCategory deleteBorrowerCategory(
		BorrowerCategory borrowerCategory) throws SystemException {
		return borrowerCategoryPersistence.remove(borrowerCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BorrowerCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return borrowerCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return borrowerCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BorrowerCategory fetchBorrowerCategory(long borrowerCategoryId)
		throws SystemException {
		return borrowerCategoryPersistence.fetchByPrimaryKey(borrowerCategoryId);
	}
	 ...
	 */
	@Override
	public BorrowerCategory getBorrowerCategory(long borrowerCategoryId)
		throws PortalException, SystemException {
		return borrowerCategoryPersistence.findByPrimaryKey(borrowerCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return borrowerCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BorrowerCategory> getBorrowerCategories(int start, int end)
		throws SystemException {
		return borrowerCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBorrowerCategoriesCount() throws SystemException {
		return borrowerCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BorrowerCategory updateBorrowerCategory(
		BorrowerCategory borrowerCategory) throws SystemException {
		return borrowerCategoryPersistence.update(borrowerCategory);
	}

	/**
	 * Returns the borrower category local service.
	 *
	 * @return the borrower category local service
	 */
	public com.idetronic.eis.service.BorrowerCategoryLocalService getBorrowerCategoryLocalService() {
		return borrowerCategoryLocalService;
	}

	/**
	 * Sets the borrower category local service.
	 *
	 * @param borrowerCategoryLocalService the borrower category local service
	 */
	public void setBorrowerCategoryLocalService(
		com.idetronic.eis.service.BorrowerCategoryLocalService borrowerCategoryLocalService) {
		this.borrowerCategoryLocalService = borrowerCategoryLocalService;
	}

	/**
	 * Returns the borrower category remote service.
	 *
	 * @return the borrower category remote service
	 */
	public com.idetronic.eis.service.BorrowerCategoryService getBorrowerCategoryService() {
		return borrowerCategoryService;
	}

	/**
	 * Sets the borrower category remote service.
	 *
	 * @param borrowerCategoryService the borrower category remote service
	 */
	public void setBorrowerCategoryService(
		com.idetronic.eis.service.BorrowerCategoryService borrowerCategoryService) {
		this.borrowerCategoryService = borrowerCategoryService;
	}

	/**
	 * Returns the borrower category persistence.
	 *
	 * @return the borrower category persistence
	 */
	public BorrowerCategoryPersistence getBorrowerCategoryPersistence() {
		return borrowerCategoryPersistence;
	}

	/**
	 * Sets the borrower category persistence.
	 *
	 * @param borrowerCategoryPersistence the borrower category persistence
	 */
	public void setBorrowerCategoryPersistence(
		BorrowerCategoryPersistence borrowerCategoryPersistence) {
		this.borrowerCategoryPersistence = borrowerCategoryPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.BorrowerCategory",
			borrowerCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = borrowerCategoryPersistence.getDataSource();
	...
	@BeanReference(type = com.idetronic.eis.service.BorrowerCategoryLocalService.class)
	protected com.idetronic.eis.service.BorrowerCategoryLocalService borrowerCategoryLocalService;
	@BeanReference(type = com.idetronic.eis.service.BorrowerCategoryService.class)
	protected com.idetronic.eis.service.BorrowerCategoryService borrowerCategoryService;
	@BeanReference(type = BorrowerCategoryPersistence.class)
	protected BorrowerCategoryPersistence borrowerCategoryPersistence;
	...
	private BorrowerCategoryLocalServiceClpInvoker _clpInvoker = new BorrowerCategoryLocalServiceClpInvoker();
}