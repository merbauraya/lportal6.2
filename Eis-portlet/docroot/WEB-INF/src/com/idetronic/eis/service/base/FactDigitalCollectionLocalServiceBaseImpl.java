...
import com.idetronic.eis.service.FactDigitalCollectionLocalService;
...
/**
 * Provides the base implementation for the fact digital collection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactDigitalCollectionLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactDigitalCollectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactDigitalCollectionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactDigitalCollectionLocalServiceUtil} to access the fact digital collection local service.
	 */
	...
	@Override
	public FactDigitalCollection addFactDigitalCollection(
		FactDigitalCollection factDigitalCollection) throws SystemException {
		factDigitalCollection.setNew(true);

		return factDigitalCollectionPersistence.update(factDigitalCollection);
	}
	 ...
	 */
	@Override
	public FactDigitalCollection createFactDigitalCollection(long factId) {
		return factDigitalCollectionPersistence.create(factId);
	}
	...
	@Override
	public FactDigitalCollection deleteFactDigitalCollection(long factId)
		throws PortalException, SystemException {
		return factDigitalCollectionPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactDigitalCollection deleteFactDigitalCollection(
		FactDigitalCollection factDigitalCollection) throws SystemException {
		return factDigitalCollectionPersistence.remove(factDigitalCollection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactDigitalCollection.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factDigitalCollectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factDigitalCollectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactDigitalCollection fetchFactDigitalCollection(long factId)
		throws SystemException {
		return factDigitalCollectionPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactDigitalCollection getFactDigitalCollection(long factId)
		throws PortalException, SystemException {
		return factDigitalCollectionPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factDigitalCollectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactDigitalCollection> getFactDigitalCollections(int start,
		int end) throws SystemException {
		return factDigitalCollectionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactDigitalCollectionsCount() throws SystemException {
		return factDigitalCollectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactDigitalCollection updateFactDigitalCollection(
		FactDigitalCollection factDigitalCollection) throws SystemException {
		return factDigitalCollectionPersistence.update(factDigitalCollection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactDigitalCollection",
			factDigitalCollectionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factDigitalCollectionPersistence.getDataSource();
	...
	private FactDigitalCollectionLocalServiceClpInvoker _clpInvoker = new FactDigitalCollectionLocalServiceClpInvoker();
}