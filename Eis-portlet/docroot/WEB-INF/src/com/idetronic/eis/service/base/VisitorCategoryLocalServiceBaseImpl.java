...
import com.idetronic.eis.service.VisitorCategoryLocalService;
...
/**
 * Provides the base implementation for the visitor category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.VisitorCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.VisitorCategoryLocalServiceImpl
 * @see com.idetronic.eis.service.VisitorCategoryLocalServiceUtil
 * @generated
 */
public abstract class VisitorCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VisitorCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.VisitorCategoryLocalServiceUtil} to access the visitor category local service.
	 */
	...
	@Override
	public VisitorCategory addVisitorCategory(VisitorCategory visitorCategory)
	 ...
	 */
	@Override
	public VisitorCategory createVisitorCategory(long visitorCategoryId) {
		return visitorCategoryPersistence.create(visitorCategoryId);
	}
	...
	@Override
	public VisitorCategory deleteVisitorCategory(long visitorCategoryId)
		throws PortalException, SystemException {
		return visitorCategoryPersistence.remove(visitorCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VisitorCategory deleteVisitorCategory(
		VisitorCategory visitorCategory) throws SystemException {
		return visitorCategoryPersistence.remove(visitorCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VisitorCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return visitorCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return visitorCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VisitorCategory fetchVisitorCategory(long visitorCategoryId)
		throws SystemException {
		return visitorCategoryPersistence.fetchByPrimaryKey(visitorCategoryId);
	}
	 ...
	 */
	@Override
	public VisitorCategory getVisitorCategory(long visitorCategoryId)
		throws PortalException, SystemException {
		return visitorCategoryPersistence.findByPrimaryKey(visitorCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return visitorCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VisitorCategory> getVisitorCategories(int start, int end)
		throws SystemException {
		return visitorCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVisitorCategoriesCount() throws SystemException {
		return visitorCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VisitorCategory updateVisitorCategory(
		VisitorCategory visitorCategory) throws SystemException {
		return visitorCategoryPersistence.update(visitorCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.VisitorCategory",
			visitorCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = visitorCategoryPersistence.getDataSource();
	...
	private VisitorCategoryLocalServiceClpInvoker _clpInvoker = new VisitorCategoryLocalServiceClpInvoker();
}