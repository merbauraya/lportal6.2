...
public class FactIncomeFinderImpl extends BasePersistenceImpl<FactIncome> implements FactIncomeFinder
{
	...
	public List<FactIncome> getLatestEntry (long libraryId,String period)
	{
	    ...
	    try {
	        ...
	        q.addEntity("FactIncome", FactIncomeImpl.class); 
	        ...
	        List<FactIncome> results = (List<FactIncome>) QueryUtil.list(q, getDialect(), QueryUtil.ALL_POS, QueryUtil.ALL_POS);
