...
import com.idetronic.eis.service.FactItManagementLocalService;
...
/**
 * Provides the base implementation for the fact it management local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactItManagementLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactItManagementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactItManagementLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactItManagementLocalServiceUtil} to access the fact it management local service.
	 */
	...
	@Override
	public FactItManagement addFactItManagement(
		FactItManagement factItManagement) throws SystemException {
		factItManagement.setNew(true);

		return factItManagementPersistence.update(factItManagement);
	}
	 ...
	 */
	@Override
	public FactItManagement createFactItManagement(long factId) {
		return factItManagementPersistence.create(factId);
	}
	...
	@Override
	public FactItManagement deleteFactItManagement(long factId)
		throws PortalException, SystemException {
		return factItManagementPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactItManagement deleteFactItManagement(
		FactItManagement factItManagement) throws SystemException {
		return factItManagementPersistence.remove(factItManagement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactItManagement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factItManagementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factItManagementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactItManagement fetchFactItManagement(long factId)
		throws SystemException {
		return factItManagementPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactItManagement getFactItManagement(long factId)
		throws PortalException, SystemException {
		return factItManagementPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factItManagementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactItManagement> getFactItManagements(int start, int end)
		throws SystemException {
		return factItManagementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactItManagementsCount() throws SystemException {
		return factItManagementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactItManagement updateFactItManagement(
		FactItManagement factItManagement) throws SystemException {
		return factItManagementPersistence.update(factItManagement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactItManagement",
			factItManagementLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactItManagement");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factItManagementPersistence.getDataSource();
	...
	private FactItManagementLocalServiceClpInvoker _clpInvoker = new FactItManagementLocalServiceClpInvoker();
}