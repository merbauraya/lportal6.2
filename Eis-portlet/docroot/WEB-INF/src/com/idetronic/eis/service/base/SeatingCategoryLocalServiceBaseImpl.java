...
import com.idetronic.eis.service.SeatingCategoryLocalService;
...
/**
 * Provides the base implementation for the seating category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.SeatingCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class SeatingCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SeatingCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.SeatingCategoryLocalServiceUtil} to access the seating category local service.
	 */
	...
	@Override
	public SeatingCategory addSeatingCategory(SeatingCategory seatingCategory)
	 ...
	 */
	@Override
	public SeatingCategory createSeatingCategory(long seatingCategoryId) {
		return seatingCategoryPersistence.create(seatingCategoryId);
	}
	...
	@Override
	public SeatingCategory deleteSeatingCategory(long seatingCategoryId)
		throws PortalException, SystemException {
		return seatingCategoryPersistence.remove(seatingCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SeatingCategory deleteSeatingCategory(
		SeatingCategory seatingCategory) throws SystemException {
		return seatingCategoryPersistence.remove(seatingCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SeatingCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return seatingCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return seatingCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SeatingCategory fetchSeatingCategory(long seatingCategoryId)
		throws SystemException {
		return seatingCategoryPersistence.fetchByPrimaryKey(seatingCategoryId);
	}
	 ...
	 */
	@Override
	public SeatingCategory getSeatingCategory(long seatingCategoryId)
		throws PortalException, SystemException {
		return seatingCategoryPersistence.findByPrimaryKey(seatingCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return seatingCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SeatingCategory> getSeatingCategories(int start, int end)
		throws SystemException {
		return seatingCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSeatingCategoriesCount() throws SystemException {
		return seatingCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SeatingCategory updateSeatingCategory(
		SeatingCategory seatingCategory) throws SystemException {
		return seatingCategoryPersistence.update(seatingCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.SeatingCategory",
			seatingCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.SeatingCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = seatingCategoryPersistence.getDataSource();
	...
	private SeatingCategoryLocalServiceClpInvoker _clpInvoker = new SeatingCategoryLocalServiceClpInvoker();
}