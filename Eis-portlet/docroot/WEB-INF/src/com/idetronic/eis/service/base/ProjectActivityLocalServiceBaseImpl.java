...
import com.idetronic.eis.service.ProjectActivityLocalService;
...
/**
 * Provides the base implementation for the project activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.ProjectActivityLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class ProjectActivityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectActivityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.ProjectActivityLocalServiceUtil} to access the project activity local service.
	 */
	...
	public ProjectActivity addProjectActivity(ProjectActivity projectActivity)
		...
		return projectActivityPersistence.update(projectActivity);
	}
	 ...
	 */
	@Override
	public ProjectActivity createProjectActivity(long projectActivityId) {
		return projectActivityPersistence.create(projectActivityId);
	}
	...
	public ProjectActivity deleteProjectActivity(long projectActivityId)
		...
		return projectActivityPersistence.remove(projectActivityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProjectActivity deleteProjectActivity(
		ProjectActivity projectActivity) throws SystemException {
		return projectActivityPersistence.remove(projectActivity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectActivity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return projectActivityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return projectActivityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectActivity fetchProjectActivity(long projectActivityId)
		throws SystemException {
		return projectActivityPersistence.fetchByPrimaryKey(projectActivityId);
	}
	 ...
	 */
	@Override
	public ProjectActivity getProjectActivity(long projectActivityId)
		throws PortalException, SystemException {
		return projectActivityPersistence.findByPrimaryKey(projectActivityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return projectActivityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectActivity> getProjectActivities(int start, int end)
		throws SystemException {
		return projectActivityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProjectActivitiesCount() throws SystemException {
		return projectActivityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProjectActivity updateProjectActivity(
		ProjectActivity projectActivity) throws SystemException {
		return projectActivityPersistence.update(projectActivity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.ProjectActivity",
			projectActivityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = projectActivityPersistence.getDataSource();
	...
	private ProjectActivityLocalServiceClpInvoker _clpInvoker = new ProjectActivityLocalServiceClpInvoker();
}