...
import com.idetronic.eis.service.UserLibraryLocalService;
...
/**
 * Provides the base implementation for the user library local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.UserLibraryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class UserLibraryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserLibraryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.UserLibraryLocalServiceUtil} to access the user library local service.
	 */
	 ...
	 */
	@Override
	public UserLibrary createUserLibrary(long userLibraryId) {
		return userLibraryPersistence.create(userLibraryId);
	}
	...
	@Override
	public UserLibrary deleteUserLibrary(long userLibraryId)
		throws PortalException, SystemException {
		return userLibraryPersistence.remove(userLibraryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserLibrary deleteUserLibrary(UserLibrary userLibrary)
		throws SystemException {
		return userLibraryPersistence.remove(userLibrary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserLibrary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userLibraryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userLibraryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userLibraryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserLibrary fetchUserLibrary(long userLibraryId)
		throws SystemException {
		return userLibraryPersistence.fetchByPrimaryKey(userLibraryId);
	}
	 ...
	 */
	@Override
	public UserLibrary getUserLibrary(long userLibraryId)
		throws PortalException, SystemException {
		return userLibraryPersistence.findByPrimaryKey(userLibraryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userLibraryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserLibrary> getUserLibraries(int start, int end)
		throws SystemException {
		return userLibraryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserLibrariesCount() throws SystemException {
		return userLibraryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserLibrary updateUserLibrary(UserLibrary userLibrary)
		throws SystemException {
		return userLibraryPersistence.update(userLibrary);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.UserLibrary",
			userLibraryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userLibraryPersistence.getDataSource();
	...
	private UserLibraryLocalServiceClpInvoker _clpInvoker = new UserLibraryLocalServiceClpInvoker();
}