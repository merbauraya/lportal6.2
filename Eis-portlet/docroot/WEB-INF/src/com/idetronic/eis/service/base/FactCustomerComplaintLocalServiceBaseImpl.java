...
import com.idetronic.eis.service.FactCustomerComplaintLocalService;
...
/**
 * Provides the base implementation for the fact customer complaint local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactCustomerComplaintLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactCustomerComplaintLocalServiceImpl
 * @see com.idetronic.eis.service.FactCustomerComplaintLocalServiceUtil
 * @generated
 */
public abstract class FactCustomerComplaintLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactCustomerComplaintLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactCustomerComplaintLocalServiceUtil} to access the fact customer complaint local service.
	 */
	...
	@Override
	public FactCustomerComplaint addFactCustomerComplaint(
		FactCustomerComplaint factCustomerComplaint) throws SystemException {
		factCustomerComplaint.setNew(true);

		return factCustomerComplaintPersistence.update(factCustomerComplaint);
	}
	 ...
	 */
	@Override
	public FactCustomerComplaint createFactCustomerComplaint(long factId) {
		return factCustomerComplaintPersistence.create(factId);
	}
	...
	@Override
	public FactCustomerComplaint deleteFactCustomerComplaint(long factId)
		throws PortalException, SystemException {
		return factCustomerComplaintPersistence.remove(factId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactCustomerComplaint deleteFactCustomerComplaint(
		FactCustomerComplaint factCustomerComplaint) throws SystemException {
		return factCustomerComplaintPersistence.remove(factCustomerComplaint);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactCustomerComplaint.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factCustomerComplaintPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factCustomerComplaintPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactCustomerComplaint fetchFactCustomerComplaint(long factId)
		throws SystemException {
		return factCustomerComplaintPersistence.fetchByPrimaryKey(factId);
	}
	 ...
	 */
	@Override
	public FactCustomerComplaint getFactCustomerComplaint(long factId)
		throws PortalException, SystemException {
		return factCustomerComplaintPersistence.findByPrimaryKey(factId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factCustomerComplaintPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactCustomerComplaint> getFactCustomerComplaints(int start,
		int end) throws SystemException {
		return factCustomerComplaintPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactCustomerComplaintsCount() throws SystemException {
		return factCustomerComplaintPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactCustomerComplaint updateFactCustomerComplaint(
		FactCustomerComplaint factCustomerComplaint) throws SystemException {
		return factCustomerComplaintPersistence.update(factCustomerComplaint);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactCustomerComplaint",
			factCustomerComplaintLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.FactCustomerComplaint");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factCustomerComplaintPersistence.getDataSource();
	...
	private FactCustomerComplaintLocalServiceClpInvoker _clpInvoker = new FactCustomerComplaintLocalServiceClpInvoker();
}