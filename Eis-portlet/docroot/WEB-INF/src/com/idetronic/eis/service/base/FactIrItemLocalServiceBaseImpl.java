...
import com.idetronic.eis.service.FactIrItemLocalService;
...
/**
 * Provides the base implementation for the fact ir item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactIrItemLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactIrItemLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactIrItemLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactIrItemLocalServiceUtil} to access the fact ir item local service.
	 */
	...
	@Override
	public FactIrItem addFactIrItem(FactIrItem factIrItem)
		throws SystemException {
		factIrItem.setNew(true);

		return factIrItemPersistence.update(factIrItem);
	}
	 ...
	 */
	@Override
	public FactIrItem createFactIrItem(long factIrItemId) {
		return factIrItemPersistence.create(factIrItemId);
	}
	...
	@Override
	public FactIrItem deleteFactIrItem(long factIrItemId)
		throws PortalException, SystemException {
		return factIrItemPersistence.remove(factIrItemId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactIrItem deleteFactIrItem(FactIrItem factIrItem)
		throws SystemException {
		return factIrItemPersistence.remove(factIrItem);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactIrItem.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factIrItemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return factIrItemPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factIrItemPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactIrItem fetchFactIrItem(long factIrItemId)
		throws SystemException {
		return factIrItemPersistence.fetchByPrimaryKey(factIrItemId);
	}
	 ...
	 */
	@Override
	public FactIrItem getFactIrItem(long factIrItemId)
		throws PortalException, SystemException {
		return factIrItemPersistence.findByPrimaryKey(factIrItemId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factIrItemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactIrItem> getFactIrItems(int start, int end)
		throws SystemException {
		return factIrItemPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactIrItemsCount() throws SystemException {
		return factIrItemPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactIrItem updateFactIrItem(FactIrItem factIrItem)
		throws SystemException {
		return factIrItemPersistence.update(factIrItem);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactIrItem",
			factIrItemLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factIrItemPersistence.getDataSource();
	...
	private FactIrItemLocalServiceClpInvoker _clpInvoker = new FactIrItemLocalServiceClpInvoker();
}