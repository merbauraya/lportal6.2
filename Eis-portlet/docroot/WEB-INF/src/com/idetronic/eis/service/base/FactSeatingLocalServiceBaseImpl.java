...
import com.idetronic.eis.service.FactSeatingLocalService;
...
/**
 * Provides the base implementation for the fact seating local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactSeatingLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactSeatingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactSeatingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactSeatingLocalServiceUtil} to access the fact seating local service.
	 */
	...
	@Override
	public FactSeating addFactSeating(FactSeating factSeating)
	 ...
	 */
	@Override
	public FactSeating createFactSeating(long factSeatingId) {
		return factSeatingPersistence.create(factSeatingId);
	}
	...
	@Override
	public FactSeating deleteFactSeating(long factSeatingId)
		throws PortalException, SystemException {
		return factSeatingPersistence.remove(factSeatingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactSeating deleteFactSeating(FactSeating factSeating)
		throws SystemException {
		return factSeatingPersistence.remove(factSeating);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactSeating.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factSeatingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return factSeatingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factSeatingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactSeating fetchFactSeating(long factSeatingId)
		throws SystemException {
		return factSeatingPersistence.fetchByPrimaryKey(factSeatingId);
	}
	 ...
	 */
	@Override
	public FactSeating getFactSeating(long factSeatingId)
		throws PortalException, SystemException {
		return factSeatingPersistence.findByPrimaryKey(factSeatingId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factSeatingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactSeating> getFactSeatings(int start, int end)
		throws SystemException {
		return factSeatingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactSeatingsCount() throws SystemException {
		return factSeatingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactSeating updateFactSeating(FactSeating factSeating)
		throws SystemException {
		return factSeatingPersistence.update(factSeating);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactSeating",
			factSeatingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factSeatingPersistence.getDataSource();
	...
	private FactSeatingLocalServiceClpInvoker _clpInvoker = new FactSeatingLocalServiceClpInvoker();
}