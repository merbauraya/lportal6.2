...
import com.idetronic.eis.service.KpiEntryLocalService;
...
/**
 * Provides the base implementation for the kpi entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.KpiEntryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.KpiEntryLocalServiceImpl
 * @see com.idetronic.eis.service.KpiEntryLocalServiceUtil
 * @generated
 */
public abstract class KpiEntryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements KpiEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.KpiEntryLocalServiceUtil} to access the kpi entry local service.
	 */
	...
	@Override
	public KpiEntry addKpiEntry(KpiEntry kpiEntry) throws SystemException {
	 ...
	 */
	@Override
	public KpiEntry createKpiEntry(long kpiEntryId) {
		return kpiEntryPersistence.create(kpiEntryId);
	}
	...
	@Override
	public KpiEntry deleteKpiEntry(long kpiEntryId)
		throws PortalException, SystemException {
		return kpiEntryPersistence.remove(kpiEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KpiEntry deleteKpiEntry(KpiEntry kpiEntry) throws SystemException {
		return kpiEntryPersistence.remove(kpiEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KpiEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return kpiEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return kpiEntryPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return kpiEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return kpiEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public KpiEntry fetchKpiEntry(long kpiEntryId) throws SystemException {
		return kpiEntryPersistence.fetchByPrimaryKey(kpiEntryId);
	}
	 ...
	 */
	@Override
	public KpiEntry getKpiEntry(long kpiEntryId)
		throws PortalException, SystemException {
		return kpiEntryPersistence.findByPrimaryKey(kpiEntryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return kpiEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KpiEntry> getKpiEntries(int start, int end)
		throws SystemException {
		return kpiEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKpiEntriesCount() throws SystemException {
		return kpiEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KpiEntry updateKpiEntry(KpiEntry kpiEntry) throws SystemException {
		return kpiEntryPersistence.update(kpiEntry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.KpiEntry",
			kpiEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = kpiEntryPersistence.getDataSource();
	...
	private KpiEntryLocalServiceClpInvoker _clpInvoker = new KpiEntryLocalServiceClpInvoker();
}