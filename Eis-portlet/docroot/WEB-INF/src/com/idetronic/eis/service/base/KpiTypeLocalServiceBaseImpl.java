...
import com.idetronic.eis.service.KpiTypeLocalService;
...
/**
 * Provides the base implementation for the kpi type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.KpiTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class KpiTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements KpiTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.KpiTypeLocalServiceUtil} to access the kpi type local service.
	 */
	...
	@Override
	public KpiType addKpiType(KpiType kpiType) throws SystemException {
		kpiType.setNew(true);
	 ...
	 */
	@Override
	public KpiType createKpiType(long kpiTypeId) {
		return kpiTypePersistence.create(kpiTypeId);
	}
	...
	@Override
	public KpiType deleteKpiType(long kpiTypeId)
		throws PortalException, SystemException {
		return kpiTypePersistence.remove(kpiTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KpiType deleteKpiType(KpiType kpiType) throws SystemException {
		return kpiTypePersistence.remove(kpiType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KpiType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return kpiTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return kpiTypePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return kpiTypePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return kpiTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return kpiTypePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public KpiType fetchKpiType(long kpiTypeId) throws SystemException {
		return kpiTypePersistence.fetchByPrimaryKey(kpiTypeId);
	}
	 ...
	 */
	@Override
	public KpiType getKpiType(long kpiTypeId)
		throws PortalException, SystemException {
		return kpiTypePersistence.findByPrimaryKey(kpiTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return kpiTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KpiType> getKpiTypes(int start, int end)
		throws SystemException {
		return kpiTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKpiTypesCount() throws SystemException {
		return kpiTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KpiType updateKpiType(KpiType kpiType) throws SystemException {
		return kpiTypePersistence.update(kpiType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.KpiType",
			kpiTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.KpiType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = kpiTypePersistence.getDataSource();
	...
	private KpiTypeLocalServiceClpInvoker _clpInvoker = new KpiTypeLocalServiceClpInvoker();
}