...
import com.idetronic.eis.service.FactIncomeLocalService;
...
/**
 * Provides the base implementation for the fact income local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactIncomeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactIncomeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactIncomeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactIncomeLocalServiceUtil} to access the fact income local service.
	 */
	...
	@Override
	public FactIncome addFactIncome(FactIncome factIncome)
		throws SystemException {
		factIncome.setNew(true);

		return factIncomePersistence.update(factIncome);
	}
	 ...
	 */
	@Override
	public FactIncome createFactIncome(long factIncomeId) {
		return factIncomePersistence.create(factIncomeId);
	}
	...
	@Override
	public FactIncome deleteFactIncome(long factIncomeId)
		throws PortalException, SystemException {
		return factIncomePersistence.remove(factIncomeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactIncome deleteFactIncome(FactIncome factIncome)
		throws SystemException {
		return factIncomePersistence.remove(factIncome);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactIncome.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factIncomePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return factIncomePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factIncomePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactIncome fetchFactIncome(long factIncomeId)
		throws SystemException {
		return factIncomePersistence.fetchByPrimaryKey(factIncomeId);
	}
	 ...
	 */
	@Override
	public FactIncome getFactIncome(long factIncomeId)
		throws PortalException, SystemException {
		return factIncomePersistence.findByPrimaryKey(factIncomeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factIncomePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactIncome> getFactIncomes(int start, int end)
		throws SystemException {
		return factIncomePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactIncomesCount() throws SystemException {
		return factIncomePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactIncome updateFactIncome(FactIncome factIncome)
		throws SystemException {
		return factIncomePersistence.update(factIncome);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactIncome",
			factIncomeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factIncomePersistence.getDataSource();
	...
	private FactIncomeLocalServiceClpInvoker _clpInvoker = new FactIncomeLocalServiceClpInvoker();
}