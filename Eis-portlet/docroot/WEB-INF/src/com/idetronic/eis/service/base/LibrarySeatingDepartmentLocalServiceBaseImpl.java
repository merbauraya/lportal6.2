...
import com.idetronic.eis.service.LibrarySeatingDepartmentLocalService;
...
/**
 * Provides the base implementation for the library seating department local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.LibrarySeatingDepartmentLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class LibrarySeatingDepartmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LibrarySeatingDepartmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.LibrarySeatingDepartmentLocalServiceUtil} to access the library seating department local service.
	 */
	...
	@Override
	public LibrarySeatingDepartment addLibrarySeatingDepartment(
		LibrarySeatingDepartment librarySeatingDepartment)
		throws SystemException {
		librarySeatingDepartment.setNew(true);

		return librarySeatingDepartmentPersistence.update(librarySeatingDepartment);
	}
	 ...
	 */
	@Override
	public LibrarySeatingDepartment createLibrarySeatingDepartment(
		long libraryDepartmentId) {
		return librarySeatingDepartmentPersistence.create(libraryDepartmentId);
	}
	...
	@Override
	public LibrarySeatingDepartment deleteLibrarySeatingDepartment(
		long libraryDepartmentId) throws PortalException, SystemException {
		return librarySeatingDepartmentPersistence.remove(libraryDepartmentId);
	}
	...
	public LibrarySeatingDepartment deleteLibrarySeatingDepartment(
		LibrarySeatingDepartment librarySeatingDepartment)
		throws SystemException {
		return librarySeatingDepartmentPersistence.remove(librarySeatingDepartment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LibrarySeatingDepartment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return librarySeatingDepartmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return librarySeatingDepartmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LibrarySeatingDepartment fetchLibrarySeatingDepartment(
		long libraryDepartmentId) throws SystemException {
		return librarySeatingDepartmentPersistence.fetchByPrimaryKey(libraryDepartmentId);
	}
	 ...
	 */
	@Override
	public LibrarySeatingDepartment getLibrarySeatingDepartment(
		long libraryDepartmentId) throws PortalException, SystemException {
		return librarySeatingDepartmentPersistence.findByPrimaryKey(libraryDepartmentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return librarySeatingDepartmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LibrarySeatingDepartment> getLibrarySeatingDepartments(
		int start, int end) throws SystemException {
		return librarySeatingDepartmentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLibrarySeatingDepartmentsCount() throws SystemException {
		return librarySeatingDepartmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LibrarySeatingDepartment updateLibrarySeatingDepartment(
		LibrarySeatingDepartment librarySeatingDepartment)
		throws SystemException {
		return librarySeatingDepartmentPersistence.update(librarySeatingDepartment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.LibrarySeatingDepartment",
			librarySeatingDepartmentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.LibrarySeatingDepartment");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = librarySeatingDepartmentPersistence.getDataSource();
	...
	private LibrarySeatingDepartmentLocalServiceClpInvoker _clpInvoker = new LibrarySeatingDepartmentLocalServiceClpInvoker();
}