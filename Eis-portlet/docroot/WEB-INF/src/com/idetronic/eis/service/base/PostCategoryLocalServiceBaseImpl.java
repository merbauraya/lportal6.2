...
import com.idetronic.eis.service.PostCategoryLocalService;
...
/**
 * Provides the base implementation for the post category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.PostCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class PostCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PostCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.PostCategoryLocalServiceUtil} to access the post category local service.
	 */
	 ...
	 */
	@Override
	public PostCategory createPostCategory(long postCategoryId) {
		return postCategoryPersistence.create(postCategoryId);
	}
	...
	@Override
	public PostCategory deletePostCategory(long postCategoryId)
		throws PortalException, SystemException {
		return postCategoryPersistence.remove(postCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PostCategory deletePostCategory(PostCategory postCategory)
		throws SystemException {
		return postCategoryPersistence.remove(postCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PostCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return postCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return postCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PostCategory fetchPostCategory(long postCategoryId)
		throws SystemException {
		return postCategoryPersistence.fetchByPrimaryKey(postCategoryId);
	}
	...
	public PostCategory getPostCategory(long postCategoryId)
		throws PortalException, SystemException {
		return postCategoryPersistence.findByPrimaryKey(postCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return postCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PostCategory> getPostCategories(int start, int end)
		throws SystemException {
		return postCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPostCategoriesCount() throws SystemException {
		return postCategoryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.PostCategory",
			postCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.PostCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = postCategoryPersistence.getDataSource();
	...
	private PostCategoryLocalServiceClpInvoker _clpInvoker = new PostCategoryLocalServiceClpInvoker();
}