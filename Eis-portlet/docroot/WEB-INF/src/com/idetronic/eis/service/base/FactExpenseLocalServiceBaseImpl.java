...
import com.idetronic.eis.service.FactExpenseLocalService;
...
/**
 * Provides the base implementation for the fact expense local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactExpenseLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactExpenseLocalServiceImpl
 * @see com.idetronic.eis.service.FactExpenseLocalServiceUtil
 * @generated
 */
public abstract class FactExpenseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactExpenseLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactExpenseLocalServiceUtil} to access the fact expense local service.
	 */
	...
	@Override
	public FactExpense addFactExpense(FactExpense factExpense)
		throws SystemException {
		factExpense.setNew(true);

		return factExpensePersistence.update(factExpense);
	}
	 ...
	 */
	@Override
	public FactExpense createFactExpense(long factExpenseId) {
		return factExpensePersistence.create(factExpenseId);
	}
	...
	@Override
	public FactExpense deleteFactExpense(long factExpenseId)
		throws PortalException, SystemException {
		return factExpensePersistence.remove(factExpenseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FactExpense deleteFactExpense(FactExpense factExpense)
		throws SystemException {
		return factExpensePersistence.remove(factExpense);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactExpense.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factExpensePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return factExpensePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factExpensePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactExpense fetchFactExpense(long factExpenseId)
		throws SystemException {
		return factExpensePersistence.fetchByPrimaryKey(factExpenseId);
	}
	 ...
	 */
	@Override
	public FactExpense getFactExpense(long factExpenseId)
		throws PortalException, SystemException {
		return factExpensePersistence.findByPrimaryKey(factExpenseId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factExpensePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactExpense> getFactExpenses(int start, int end)
		throws SystemException {
		return factExpensePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactExpensesCount() throws SystemException {
		return factExpensePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactExpense updateFactExpense(FactExpense factExpense)
		throws SystemException {
		return factExpensePersistence.update(factExpense);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactExpense",
			factExpenseLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factExpensePersistence.getDataSource();
	...
	private FactExpenseLocalServiceClpInvoker _clpInvoker = new FactExpenseLocalServiceClpInvoker();
}