...
import com.idetronic.eis.service.ProjectStrategyLocalService;
...
/**
 * Provides the base implementation for the project strategy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.ProjectStrategyLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class ProjectStrategyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectStrategyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.ProjectStrategyLocalServiceUtil} to access the project strategy local service.
	 */
	...
	@Override
	public ProjectStrategy addProjectStrategy(ProjectStrategy projectStrategy)
		throws SystemException {
		projectStrategy.setNew(true);

		return projectStrategyPersistence.update(projectStrategy);
	}
	 ...
	 */
	@Override
	public ProjectStrategy createProjectStrategy(long projectStrategyId) {
		return projectStrategyPersistence.create(projectStrategyId);
	}
	...
	@Override
	public ProjectStrategy deleteProjectStrategy(long projectStrategyId)
		throws PortalException, SystemException {
		return projectStrategyPersistence.remove(projectStrategyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProjectStrategy deleteProjectStrategy(
		ProjectStrategy projectStrategy) throws SystemException {
		return projectStrategyPersistence.remove(projectStrategy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectStrategy.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return projectStrategyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return projectStrategyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectStrategy fetchProjectStrategy(long projectStrategyId)
		throws SystemException {
		return projectStrategyPersistence.fetchByPrimaryKey(projectStrategyId);
	}
	 ...
	 */
	@Override
	public ProjectStrategy getProjectStrategy(long projectStrategyId)
		throws PortalException, SystemException {
		return projectStrategyPersistence.findByPrimaryKey(projectStrategyId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return projectStrategyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectStrategy> getProjectStrategies(int start, int end)
		throws SystemException {
		return projectStrategyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProjectStrategiesCount() throws SystemException {
		return projectStrategyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProjectStrategy updateProjectStrategy(
		ProjectStrategy projectStrategy) throws SystemException {
		return projectStrategyPersistence.update(projectStrategy);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.ProjectStrategy",
			projectStrategyLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = projectStrategyPersistence.getDataSource();
	...
	private ProjectStrategyLocalServiceClpInvoker _clpInvoker = new ProjectStrategyLocalServiceClpInvoker();
}