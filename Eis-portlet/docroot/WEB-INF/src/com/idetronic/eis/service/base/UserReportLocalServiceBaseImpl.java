...
import com.idetronic.eis.service.UserReportLocalService;
...
/**
 * Provides the base implementation for the user report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.UserReportLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class UserReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.UserReportLocalServiceUtil} to access the user report local service.
	 */
	...
	public UserReport addUserReport(UserReport userReport)
		...
		return userReportPersistence.update(userReport);
	}
	 ...
	 */
	@Override
	public UserReport createUserReport(long userReportId) {
		return userReportPersistence.create(userReportId);
	}
	...
	@Override
	public UserReport deleteUserReport(long userReportId)
		throws PortalException, SystemException {
		return userReportPersistence.remove(userReportId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserReport deleteUserReport(UserReport userReport)
		throws SystemException {
		return userReportPersistence.remove(userReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userReportPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserReport fetchUserReport(long userReportId)
		throws SystemException {
		return userReportPersistence.fetchByPrimaryKey(userReportId);
	}
	 ...
	 */
	@Override
	public UserReport getUserReport(long userReportId)
		throws PortalException, SystemException {
		return userReportPersistence.findByPrimaryKey(userReportId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserReport> getUserReports(int start, int end)
		throws SystemException {
		return userReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserReportsCount() throws SystemException {
		return userReportPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.UserReport",
			userReportLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userReportPersistence.getDataSource();
	...
	private UserReportLocalServiceClpInvoker _clpInvoker = new UserReportLocalServiceClpInvoker();
}