...
public class FactExpenseFinderImpl extends BasePersistenceImpl<FactExpense> implements FactExpenseFinder
{
	...
	public List<FactExpense> getLatestEntry (long libraryId,String period)
	{
	    ...
	    try {
	        ...
	        q.addEntity("FactExpense", FactExpenseImpl.class); 
	        ...
	        List<FactExpense> results = (List<FactExpense>) QueryUtil.list(q, getDialect(), QueryUtil.ALL_POS, QueryUtil.ALL_POS);
