...
import com.idetronic.eis.service.LoanLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.LoanLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
...
public abstract class LoanLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.LoanLocalServiceUtil} to access the loan local service.
	 */
	 ...
	 */
	@Override
	public Loan createLoan(long loanEntryId) {
		return loanPersistence.create(loanEntryId);
	}
	...
	@Override
	public Loan deleteLoan(long loanEntryId)
		throws PortalException, SystemException {
		return loanPersistence.remove(loanEntryId);
	}
	...
	@Override
	public Loan fetchLoan(long loanEntryId) throws SystemException {
		return loanPersistence.fetchByPrimaryKey(loanEntryId);
	}
	 ...
	 */
	@Override
	public Loan getLoan(long loanEntryId)
		throws PortalException, SystemException {
		return loanPersistence.findByPrimaryKey(loanEntryId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.Loan",
			loanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.Loan");
	}
