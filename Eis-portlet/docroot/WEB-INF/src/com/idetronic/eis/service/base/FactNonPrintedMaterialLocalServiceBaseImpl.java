...
import com.idetronic.eis.service.FactNonPrintedMaterialLocalService;
...
/**
 * Provides the base implementation for the fact non printed material local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactNonPrintedMaterialLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.eis.service.impl.FactNonPrintedMaterialLocalServiceImpl
 * @see com.idetronic.eis.service.FactNonPrintedMaterialLocalServiceUtil
 * @generated
 */
public abstract class FactNonPrintedMaterialLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactNonPrintedMaterialLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactNonPrintedMaterialLocalServiceUtil} to access the fact non printed material local service.
	 */
	...
	@Override
	public FactNonPrintedMaterial addFactNonPrintedMaterial(
		FactNonPrintedMaterial factNonPrintedMaterial)
		throws SystemException {
		factNonPrintedMaterial.setNew(true);

		return factNonPrintedMaterialPersistence.update(factNonPrintedMaterial);
	}
	 ...
	 */
	@Override
	public FactNonPrintedMaterial createFactNonPrintedMaterial(
		long factNonPrintedMaterialId) {
		return factNonPrintedMaterialPersistence.create(factNonPrintedMaterialId);
	}
	...
	@Override
	public FactNonPrintedMaterial deleteFactNonPrintedMaterial(
		long factNonPrintedMaterialId) throws PortalException, SystemException {
		return factNonPrintedMaterialPersistence.remove(factNonPrintedMaterialId);
	}
	...
	public FactNonPrintedMaterial deleteFactNonPrintedMaterial(
		FactNonPrintedMaterial factNonPrintedMaterial)
		throws SystemException {
		return factNonPrintedMaterialPersistence.remove(factNonPrintedMaterial);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactNonPrintedMaterial.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return factNonPrintedMaterialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factNonPrintedMaterialPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactNonPrintedMaterial fetchFactNonPrintedMaterial(
		long factNonPrintedMaterialId) throws SystemException {
		return factNonPrintedMaterialPersistence.fetchByPrimaryKey(factNonPrintedMaterialId);
	}
	 ...
	 */
	@Override
	public FactNonPrintedMaterial getFactNonPrintedMaterial(
		long factNonPrintedMaterialId) throws PortalException, SystemException {
		return factNonPrintedMaterialPersistence.findByPrimaryKey(factNonPrintedMaterialId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factNonPrintedMaterialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactNonPrintedMaterial> getFactNonPrintedMaterials(int start,
		int end) throws SystemException {
		return factNonPrintedMaterialPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactNonPrintedMaterialsCount() throws SystemException {
		return factNonPrintedMaterialPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactNonPrintedMaterial updateFactNonPrintedMaterial(
		FactNonPrintedMaterial factNonPrintedMaterial)
		throws SystemException {
		return factNonPrintedMaterialPersistence.update(factNonPrintedMaterial);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactNonPrintedMaterial",
			factNonPrintedMaterialLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factNonPrintedMaterialPersistence.getDataSource();
	...
	private FactNonPrintedMaterialLocalServiceClpInvoker _clpInvoker = new FactNonPrintedMaterialLocalServiceClpInvoker();
}