 ...
 * @generated
 */
public class FactNonPrintedMaterialServiceClpInvoker {
	public FactNonPrintedMaterialServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName264.equals(name) &&
			...
			return FactNonPrintedMaterialServiceUtil.getBeanIdentifier();
		}

		if (_methodName265.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes265, parameterTypes)) {
			FactNonPrintedMaterialServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
