...
import com.idetronic.eis.service.FactPrintedMaterialLocalService;
...
/**
 * Provides the base implementation for the fact printed material local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.FactPrintedMaterialLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FactPrintedMaterialLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FactPrintedMaterialLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.FactPrintedMaterialLocalServiceUtil} to access the fact printed material local service.
	 */
	...
	@Override
	public FactPrintedMaterial addFactPrintedMaterial(
		FactPrintedMaterial factPrintedMaterial) throws SystemException {
		factPrintedMaterial.setNew(true);

		return factPrintedMaterialPersistence.update(factPrintedMaterial);
	}
	 ...
	 */
	@Override
	public FactPrintedMaterial createFactPrintedMaterial(
		long factPrintedMaterialId) {
		return factPrintedMaterialPersistence.create(factPrintedMaterialId);
	}
	...
	@Override
	public FactPrintedMaterial deleteFactPrintedMaterial(
		long factPrintedMaterialId) throws PortalException, SystemException {
		return factPrintedMaterialPersistence.remove(factPrintedMaterialId);
	}
	...
	public FactPrintedMaterial deleteFactPrintedMaterial(
		FactPrintedMaterial factPrintedMaterial) throws SystemException {
		return factPrintedMaterialPersistence.remove(factPrintedMaterial);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FactPrintedMaterial.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return factPrintedMaterialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return factPrintedMaterialPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FactPrintedMaterial fetchFactPrintedMaterial(
		long factPrintedMaterialId) throws SystemException {
		return factPrintedMaterialPersistence.fetchByPrimaryKey(factPrintedMaterialId);
	}
	 ...
	 */
	@Override
	public FactPrintedMaterial getFactPrintedMaterial(
		long factPrintedMaterialId) throws PortalException, SystemException {
		return factPrintedMaterialPersistence.findByPrimaryKey(factPrintedMaterialId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return factPrintedMaterialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FactPrintedMaterial> getFactPrintedMaterials(int start, int end)
		throws SystemException {
		return factPrintedMaterialPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFactPrintedMaterialsCount() throws SystemException {
		return factPrintedMaterialPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FactPrintedMaterial updateFactPrintedMaterial(
		FactPrintedMaterial factPrintedMaterial) throws SystemException {
		return factPrintedMaterialPersistence.update(factPrintedMaterial);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.FactPrintedMaterial",
			factPrintedMaterialLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = factPrintedMaterialPersistence.getDataSource();
	...
	private FactPrintedMaterialLocalServiceClpInvoker _clpInvoker = new FactPrintedMaterialLocalServiceClpInvoker();
}