...
import com.idetronic.eis.service.NonPrintedItemTypeLocalService;
...
/**
 * Provides the base implementation for the non printed item type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.NonPrintedItemTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class NonPrintedItemTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NonPrintedItemTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.NonPrintedItemTypeLocalServiceUtil} to access the non printed item type local service.
	 */
	...
	@Override
	public NonPrintedItemType addNonPrintedItemType(
		NonPrintedItemType nonPrintedItemType) throws SystemException {
		nonPrintedItemType.setNew(true);

		return nonPrintedItemTypePersistence.update(nonPrintedItemType);
	}
	 ...
	 */
	@Override
	public NonPrintedItemType createNonPrintedItemType(long itemTypeId) {
		return nonPrintedItemTypePersistence.create(itemTypeId);
	}
	...
	@Override
	public NonPrintedItemType deleteNonPrintedItemType(long itemTypeId)
		throws PortalException, SystemException {
		return nonPrintedItemTypePersistence.remove(itemTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NonPrintedItemType deleteNonPrintedItemType(
		NonPrintedItemType nonPrintedItemType) throws SystemException {
		return nonPrintedItemTypePersistence.remove(nonPrintedItemType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NonPrintedItemType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return nonPrintedItemTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return nonPrintedItemTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NonPrintedItemType fetchNonPrintedItemType(long itemTypeId)
		throws SystemException {
		return nonPrintedItemTypePersistence.fetchByPrimaryKey(itemTypeId);
	}
	 ...
	 */
	@Override
	public NonPrintedItemType getNonPrintedItemType(long itemTypeId)
		throws PortalException, SystemException {
		return nonPrintedItemTypePersistence.findByPrimaryKey(itemTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return nonPrintedItemTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NonPrintedItemType> getNonPrintedItemTypes(int start, int end)
		throws SystemException {
		return nonPrintedItemTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getNonPrintedItemTypesCount() throws SystemException {
		return nonPrintedItemTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NonPrintedItemType updateNonPrintedItemType(
		NonPrintedItemType nonPrintedItemType) throws SystemException {
		return nonPrintedItemTypePersistence.update(nonPrintedItemType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.NonPrintedItemType",
			nonPrintedItemTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = nonPrintedItemTypePersistence.getDataSource();
	...
	private NonPrintedItemTypeLocalServiceClpInvoker _clpInvoker = new NonPrintedItemTypeLocalServiceClpInvoker();
}