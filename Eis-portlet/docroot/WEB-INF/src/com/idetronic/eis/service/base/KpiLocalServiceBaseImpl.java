...
import com.idetronic.eis.service.KpiLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.eis.service.impl.KpiLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
...
public abstract class KpiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements KpiLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.eis.service.KpiLocalServiceUtil} to access the kpi local service.
	 */
	...
	@Override
	public Kpi addKpi(Kpi kpi) throws SystemException {
		kpi.setNew(true);
	 ...
	 */
	@Override
	public Kpi createKpi(long id) {
		return kpiPersistence.create(id);
	}
	...
	@Override
	public Kpi deleteKpi(long id) throws PortalException, SystemException {
		return kpiPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Kpi deleteKpi(Kpi kpi) throws SystemException {
	...
	@Override
	public Kpi fetchKpi(long id) throws SystemException {
		return kpiPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public Kpi getKpi(long id) throws PortalException, SystemException {
		return kpiPersistence.findByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public List<Kpi> getKpis(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getKpisCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Kpi updateKpi(Kpi kpi) throws SystemException {
		return kpiPersistence.update(kpi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.eis.model.Kpi",
			kpiLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.idetronic.eis.model.Kpi");
	}
	...
	private KpiLocalServiceClpInvoker _clpInvoker = new KpiLocalServiceClpInvoker();
}