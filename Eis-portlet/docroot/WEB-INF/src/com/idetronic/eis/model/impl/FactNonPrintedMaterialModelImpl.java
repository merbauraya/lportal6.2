...
import com.idetronic.eis.model.FactNonPrintedMaterialModel;
import com.idetronic.eis.model.FactNonPrintedMaterialSoap;
...
/**
 * The base model implementation for the FactNonPrintedMaterial service. Represents a row in the &quot;eis_FactNonPrintedMaterial&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.idetronic.eis.model.FactNonPrintedMaterialModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FactNonPrintedMaterialImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see FactNonPrintedMaterialImpl
 * @see com.idetronic.eis.model.FactNonPrintedMaterial
 * @see com.idetronic.eis.model.FactNonPrintedMaterialModel
 * @generated
 */
@JSON(strict = true)
public class FactNonPrintedMaterialModelImpl extends BaseModelImpl<FactNonPrintedMaterial>
	implements FactNonPrintedMaterialModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a fact non printed material model instance should use the {@link com.idetronic.eis.model.FactNonPrintedMaterial} interface instead.
	 */
	public static final String TABLE_NAME = "eis_FactNonPrintedMaterial";
	public static final Object[][] TABLE_COLUMNS = {
			{ "factNonPrintedMaterialId", Types.BIGINT },
	...
	public static final String TABLE_SQL_CREATE = "create table eis_FactNonPrintedMaterial (factNonPrintedMaterialId LONG not null primary key,libraryId LONG,libraryCode VARCHAR(10) null,stateId LONG,stateCode VARCHAR(10) null,libraryTypeId LONG,itemTypeId LONG,period VARCHAR(10) null,monthVal INTEGER,yearVal INTEGER,titleTotal INTEGER,volumeTotal INTEGER,dateCreated DATE null,createdByUserName VARCHAR(75) null,createdByUserId LONG)";
	public static final String TABLE_SQL_DROP = "drop table eis_FactNonPrintedMaterial";
	public static final String ORDER_BY_JPQL = " ORDER BY factNonPrintedMaterial.factNonPrintedMaterialId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY eis_FactNonPrintedMaterial.factNonPrintedMaterialId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.idetronic.eis.model.FactNonPrintedMaterial"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.idetronic.eis.model.FactNonPrintedMaterial"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.idetronic.eis.model.FactNonPrintedMaterial"),
			true);
	public static long LIBRARYID_COLUMN_BITMASK = 1L;
	public static long PERIOD_COLUMN_BITMASK = 2L;
	public static long FACTNONPRINTEDMATERIALID_COLUMN_BITMASK = 4L;
	 ...
	 */
	public static FactNonPrintedMaterial toModel(
		FactNonPrintedMaterialSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		FactNonPrintedMaterial model = new FactNonPrintedMaterialImpl();

		model.setFactNonPrintedMaterialId(soapModel.getFactNonPrintedMaterialId());
	 ...
	 */
	public static List<FactNonPrintedMaterial> toModels(
		FactNonPrintedMaterialSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<FactNonPrintedMaterial> models = new ArrayList<FactNonPrintedMaterial>(soapModels.length);

		for (FactNonPrintedMaterialSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.idetronic.eis.model.FactNonPrintedMaterial"));

	public FactNonPrintedMaterialModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			FactNonPrintedMaterial.class.getName(), getPrimaryKey());
	}
	...
	public FactNonPrintedMaterial toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (FactNonPrintedMaterial)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		factNonPrintedMaterialImpl.setFactNonPrintedMaterialId(getFactNonPrintedMaterialId());
		factNonPrintedMaterialImpl.setLibraryId(getLibraryId());
		factNonPrintedMaterialImpl.setLibraryCode(getLibraryCode());
		factNonPrintedMaterialImpl.setStateId(getStateId());
		factNonPrintedMaterialImpl.setStateCode(getStateCode());
		factNonPrintedMaterialImpl.setLibraryTypeId(getLibraryTypeId());
		factNonPrintedMaterialImpl.setItemTypeId(getItemTypeId());
		factNonPrintedMaterialImpl.setPeriod(getPeriod());
		factNonPrintedMaterialImpl.setMonthVal(getMonthVal());
		factNonPrintedMaterialImpl.setYearVal(getYearVal());
		factNonPrintedMaterialImpl.setTitleTotal(getTitleTotal());
		factNonPrintedMaterialImpl.setVolumeTotal(getVolumeTotal());
		factNonPrintedMaterialImpl.setDateCreated(getDateCreated());
		factNonPrintedMaterialImpl.setCreatedByUserName(getCreatedByUserName());
		factNonPrintedMaterialImpl.setCreatedByUserId(getCreatedByUserId());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FactNonPrintedMaterial)) {
			return false;
		}

		FactNonPrintedMaterial factNonPrintedMaterial = (FactNonPrintedMaterial)obj;
	...
	public void resetOriginalValues() {
		FactNonPrintedMaterialModelImpl factNonPrintedMaterialModelImpl = this;

		factNonPrintedMaterialModelImpl._originalLibraryId = factNonPrintedMaterialModelImpl._libraryId;

		factNonPrintedMaterialModelImpl._setOriginalLibraryId = false;

		factNonPrintedMaterialModelImpl._originalPeriod = factNonPrintedMaterialModelImpl._period;

		factNonPrintedMaterialModelImpl._columnBitmask = 0;
	}

	@Override
	public CacheModel<FactNonPrintedMaterial> toCacheModel() {
		FactNonPrintedMaterialCacheModel factNonPrintedMaterialCacheModel = new FactNonPrintedMaterialCacheModel();

		factNonPrintedMaterialCacheModel.factNonPrintedMaterialId = getFactNonPrintedMaterialId();

		factNonPrintedMaterialCacheModel.libraryId = getLibraryId();

		factNonPrintedMaterialCacheModel.libraryCode = getLibraryCode();

		String libraryCode = factNonPrintedMaterialCacheModel.libraryCode;

		if ((libraryCode != null) && (libraryCode.length() == 0)) {
			factNonPrintedMaterialCacheModel.libraryCode = null;
		}

		factNonPrintedMaterialCacheModel.stateId = getStateId();

		factNonPrintedMaterialCacheModel.stateCode = getStateCode();

		String stateCode = factNonPrintedMaterialCacheModel.stateCode;

		if ((stateCode != null) && (stateCode.length() == 0)) {
			factNonPrintedMaterialCacheModel.stateCode = null;
		}

		factNonPrintedMaterialCacheModel.libraryTypeId = getLibraryTypeId();

		factNonPrintedMaterialCacheModel.itemTypeId = getItemTypeId();

		factNonPrintedMaterialCacheModel.period = getPeriod();

		String period = factNonPrintedMaterialCacheModel.period;

		if ((period != null) && (period.length() == 0)) {
			factNonPrintedMaterialCacheModel.period = null;
		}

		factNonPrintedMaterialCacheModel.monthVal = getMonthVal();

		factNonPrintedMaterialCacheModel.yearVal = getYearVal();

		factNonPrintedMaterialCacheModel.titleTotal = getTitleTotal();

		factNonPrintedMaterialCacheModel.volumeTotal = getVolumeTotal();

		Date dateCreated = getDateCreated();

		if (dateCreated != null) {
			factNonPrintedMaterialCacheModel.dateCreated = dateCreated.getTime();
		}
		else {
			factNonPrintedMaterialCacheModel.dateCreated = Long.MIN_VALUE;
		}

		factNonPrintedMaterialCacheModel.createdByUserName = getCreatedByUserName();

		String createdByUserName = factNonPrintedMaterialCacheModel.createdByUserName;

		if ((createdByUserName != null) && (createdByUserName.length() == 0)) {
			factNonPrintedMaterialCacheModel.createdByUserName = null;
		}

		factNonPrintedMaterialCacheModel.createdByUserId = getCreatedByUserId();

		return factNonPrintedMaterialCacheModel;
	}
	...
	private static ClassLoader _classLoader = FactNonPrintedMaterial.class.getClassLoader();
	private static Class<?>[] _escapedModelInterfaces = new Class[] {
			FactNonPrintedMaterial.class
		};
	...
	private FactNonPrintedMaterial _escapedModel;
}